...
<div class="min-h-screen">
    ...
    <section class="bg-gradient-to-r from-vttu-red to-vttu-dark text-white py-20">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="text-center">
                    <div class="bg-vttu-yellow/10 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="{{ $item->icon ?? 'fas fa-star' }} text-vttu-red text-2xl"></i>
                    </div>
                    ...
                    <a href="{{ $item->url ?? route($item->route_name) }}" class="inline-block mt-4 text-vttu-red hover:text-vttu-dark font-medium">
                        Xem chi tiết →
                    </a>
                    @endif
                </div>
