<div class="space-y-6 animate-fade-in">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
        ...
        <div class="flex flex-col h-full bg-white rounded-sm overflow-hidden border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <a href="{{ route('site.oer.intro') }}" class="w-full bg-[#7B0000] hover:bg-[#5A0000] text-white py-4 text-center font-black uppercase tracking-widest text-sm transition-colors cursor-pointer select-none shadow-sm">
                {{ __('Giới thiệu') }}
            </a>
        </div>
        ...
        <div class="flex flex-col h-full bg-white rounded-sm overflow-hidden border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <!-- Large Red Full Width Button -->
            <a href="{{ route('site.page', 'tai-nguyen-giao-duc-mo') }}" class="w-full bg-[#7B0000] hover:bg-[#5A0000] text-white py-4 text-center font-black uppercase tracking-widest text-sm transition-colors cursor-pointer select-none shadow-sm">
                {{ __('Kho tài liệu') }}
            </a>
        </div>
    </div>
