                            ...
                            <div class="flex-1 flex flex-col">
                                <div class="flex justify-between items-start">
                                    <div class="flex-1">
                                        ...
                                        @if($summary)
                                            <p class="text-sm text-slate-500 line-clamp-2 leading-relaxed mb-4 italic">"{{ Str::limit($summary, 180) }}"</p>
                                        @endif
                                    </div>
                                    <div class="ml-4">
                                        <a href="{{ route('opac.book.show', $book->id) }}" class="inline-flex items-center px-6 py-3 bg-vttu-red hover:bg-vttu-dark text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all shadow-lg shadow-vttu-red/20">
                                            Chi tiết
