<div class="space-y-4 animate-fade-in">
    ...
    <div class="grid md:grid-cols-2 gap-3">
        ...
        <!-- Feature 2 -->
        <div class="bg-card border border-border rounded-md p-4 shadow-sm hover:bg-muted/50 transition-colors relative overflow-hidden group">
            <div class="absolute top-0 left-0 w-1 h-full bg-vttu-yellow"></div>
            <div class="flex items-start gap-3 pl-1">
                <div class="w-8 h-8 bg-vttu-yellow/20 rounded flex items-center justify-center text-vttu-dark flex-shrink-0">
                    <i data-lucide="bell" class="w-4 h-4 text-vttu-red"></i>
                </div>
                <div>
                    <h4 class="font-bold text-foreground text-sm mb-1">Thông Báo Tự Động</h4>
