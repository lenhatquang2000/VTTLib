                            ...
                            <nav class="p-4">
                                @if($sidebarItems->count() > 0)
                                    @foreach($sidebarItems as $item)
                                        <a href="{{ $item->getUrl() }}" 
                                           class="group flex items-center justify-between px-6 py-4 rounded-2xl transition-all mb-1 {{ $node->id === $item->id ? 'bg-vttu-red text-white shadow-xl shadow-vttu-red/20' : 'text-vttu-dark/70 hover:bg-slate-50 hover:text-vttu-red' }}">
                ...
                <main class="lg:col-span-9 space-y-12">
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-6">
                        ...
                        <div class="w-full md:w-1/2">
                            @if($prev)
                                <a href="{{ $prev->getUrl() }}" class="flex items-center gap-6 p-6 bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:border-vttu-red/20 transition-all group">
                        ...
                        <div class="w-full md:w-1/2">
                            @if($next)
                                <a href="{{ $next->getUrl() }}" class="flex items-center justify-end gap-6 p-6 bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:border-vttu-red/20 transition-all group text-right">
                                    <div>
