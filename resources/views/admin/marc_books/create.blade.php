                        ...
                        <div class="p-4 bg-indigo-50/30 dark:bg-indigo-900/10 rounded-xl border border-indigo-100 dark:border-indigo-900/30 space-y-4">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label for="create_waits_for_print" class="ml-1.5 text-[8px] font-bold text-gray-500 uppercase">{{ __('Wait for print') }}</label>
                                </div>
                            </div>
        ...
        return {
            ...
            addTagToSnapshot() {
                ...
                if (this.marcFields[tag]) {
                    Swal.fire({
                        title: '{{ __("Thông báo") }}',
                        text: '{{ __("Tag này đã tồn tại trong biểu mẫu.") }}',
                        icon: 'info'
                    });
                    return;
                }
