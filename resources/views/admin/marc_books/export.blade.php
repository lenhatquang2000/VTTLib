...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-slate-100">{{ __('MARC Export & Reports') }}</h1>
            <p class="text-sm text-gray-500 dark:text-slate-400 mt-1">{{ __('Export MARC records and generate comprehensive reports') }}</p>
        </div>
        <div>
            <a href="{{ route('admin.marc.book') }}" class="flex items-center px-4 py-2.5 text-sm font-semibold bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-slate-400 hover:bg-gray-200 dark:hover:bg-slate-700 rounded-lg transition">
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-6">
        <form action="{{ route('admin.marc.export.download') }}" method="GET" target="_blank">
            ...
            <!-- Filters Section -->
            <div class="mb-6">
                <h2 class="text-lg font-semibold text-gray-800 dark:text-slate-100 mb-4">{{ __('Export Filters') }}</h2>
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <!-- Framework Filter -->
                    <div class="space-y-2">
                        <label for="framework_id" class="block text-sm font-medium text-gray-700 dark:text-slate-300">{{ __('Cataloging Framework') }}</label>
                    ...
                    <div class="space-y-2">
                        <label for="document_type_id" class="block text-sm font-medium text-gray-700 dark:text-slate-300">{{ __('Document Type') }}</label>
                    ...
                    <!-- Date Range -->
                    <div class="space-y-2">
                        <label class="block text-sm font-medium text-gray-700 dark:text-slate-300">{{ __('Date Range') }}</label>
            ...
            <!-- Export Options -->
            <div class="mb-6">
                <h2 class="text-lg font-semibold text-gray-800 dark:text-slate-100 mb-4">{{ __('Export Options') }}</h2>
                ...
                <!-- Export Format -->
                <div class="space-y-3">
                    <label class="block text-sm font-medium text-gray-700 dark:text-slate-300">{{ __('Export Format') }}</label>
                    <div class="space-y-2">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="{{ route('admin.marc.import.index') }}" class="bg-blue-100 hover:bg-blue-200 dark:bg-blue-900/30 dark:hover:bg-blue-900/50 text-blue-600 dark:text-blue-400 px-4 py-2.5 rounded-lg text-sm font-semibold transition flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-6">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-slate-100">{{ __('Báo cáo Phân Hệ Biên Mục') }}</h2>
            <div class="flex items-center space-x-2 text-sm text-gray-500 dark:text-slate-400">
                ...
                <span>{{ __('Subsystem Reports') }}</span>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:shadow-md transition">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <h3 class="font-medium text-gray-900 dark:text-slate-100 mb-1">{{ __('Báo cáo theo Framework') }}</h3>
                        <p class="text-sm text-gray-600 dark:text-slate-400 mb-3">{{ __('Thống kê theo từng framework biên mục') }}</p>
            ...
            <div class="border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:shadow-md transition">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <h3 class="font-medium text-gray-900 dark:text-slate-100 mb-1">{{ __('Báo cáo theo Loại Tài liệu') }}</h3>
                        <p class="text-sm text-gray-600 dark:text-slate-400 mb-3">{{ __('Phân tích theo loại tài liệu') }}</p>
                        <div class="flex flex-wrap gap-2">
            ...
            <div class="border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:shadow-md transition">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <h3 class="font-medium text-gray-900 dark:text-slate-100 mb-1">{{ __('Năng suất Biên mục') }}</h3>
                        <p class="text-sm text-gray-600 dark:text-slate-400 mb-3">{{ __('Hiệu suất làm việc theo người dùng') }}</p>
                        <div class="flex flex-wrap gap-2">
            ...
            <div class="border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:shadow-md transition">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <h3 class="font-medium text-gray-900 dark:text-slate-100 mb-1">{{ __('Chất lượng Biên mục') }}</h3>
                        <p class="text-sm text-gray-600 dark:text-slate-400 mb-3">{{ __('Đánh giá chất lượng bản ghi') }}</p>
                        <div class="flex flex-wrap gap-2">
            ...
            <div class="border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:shadow-md transition">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <h3 class="font-medium text-gray-900 dark:text-slate-100 mb-1">{{ __('Báo cáo Theo Phòng Ban') }}</h3>
                        <p class="text-sm text-gray-600 dark:text-slate-400 mb-3">{{ __('Thống kê theo từng phòng ban') }}</p>
                        <div class="flex flex-wrap gap-2">
            ...
            <div class="border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:shadow-md transition">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <h3 class="font-medium text-gray-900 dark:text-slate-100 mb-1">{{ __('Báo cáo Tổng Hợp') }}</h3>
                        <p class="text-sm text-gray-600 dark:text-slate-400 mb-3">{{ __('Tất cả báo cáo trong một file') }}</p>
                        <div class="flex flex-wrap gap-2">
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-6">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-slate-100">{{ __('Báo cáo Tài liệu') }}</h2>
            <div class="flex items-center space-x-2 text-sm text-gray-500 dark:text-slate-400">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                </svg>
                <span>{{ __('Document Reports') }}</span>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:shadow-md transition">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <h3 class="font-medium text-gray-900 dark:text-slate-100 mb-1">{{ __('Thống kê Tài liệu') }}</h3>
                        <p class="text-sm text-gray-600 dark:text-slate-400 mb-3">{{ __('Số liệu thống kê tài liệu tổng quan') }}</p>
                        <div class="flex flex-wrap gap-2">
            ...
            <div class="border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:shadow-md transition">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <h3 class="font-medium text-gray-900 dark:text-slate-100 mb-1">{{ __('Danh mục Tài liệu') }}</h3>
                        <p class="text-sm text-gray-600 dark:text-slate-400 mb-3">{{ __('Danh sách đầy đủ tài liệu') }}</p>
                        <div class="flex flex-wrap gap-2">
            ...
            <div class="border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:shadow-md transition">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <h3 class="font-medium text-gray-900 dark:text-slate-100 mb-1">{{ __('Tài liệu Theo Thể loại') }}</h3>
                        <p class="text-sm text-gray-600 dark:text-slate-400 mb-3">{{ __('Phân loại theo chủ đề, thể loại') }}</p>
                        <div class="flex flex-wrap gap-2">
            ...
            <div class="border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:shadow-md transition">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <h3 class="font-medium text-gray-900 dark:text-slate-100 mb-1">{{ __('Tài liệu Mới') }}</h3>
                        <p class="text-sm text-gray-600 dark:text-slate-400 mb-3">{{ __('Tài liệu thêm mới trong khoảng thời gian') }}</p>
                        <div class="flex flex-wrap gap-2">
            ...
            <div class="border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:shadow-md transition">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <h3 class="font-medium text-gray-900 dark:text-slate-100 mb-1">{{ __('Tài liệu Đã Xuất bản') }}</h3>
                        <p class="text-sm text-gray-600 dark:text-slate-400 mb-3">{{ __('Các tài liệu đã xuất bản chính thức') }}</p>
                        <div class="flex flex-wrap gap-2">
            ...
            <div class="border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:shadow-md transition">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <h3 class="font-medium text-gray-900 dark:text-slate-100 mb-1">{{ __('Theo Năm Xuất bản') }}</h3>
                        <p class="text-sm text-gray-600 dark:text-slate-400 mb-3">{{ __('Phân tích theo năm xuất bản') }}</p>
                        <div class="flex flex-wrap gap-2">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-6">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <div class="text-2xl font-bold text-gray-900 dark:text-slate-100">{{ App\Models\BibliographicRecord::count() }}</div>
                    <div class="text-sm font-medium text-gray-600 dark:text-slate-400">{{ __('Total Records') }}</div>
                </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-6">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <div class="text-2xl font-bold text-gray-900 dark:text-slate-100">{{ App\Models\BibliographicRecord::where('status', 'approved')->count() }}</div>
                    <div class="text-sm font-medium text-gray-600 dark:text-slate-400">{{ __('Approved Records') }}</div>
                </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-6">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <div class="text-2xl font-bold text-gray-900 dark:text-slate-100">{{ App\Models\BibliographicRecord::where('status', 'pending')->count() }}</div>
                    <div class="text-sm font-medium text-gray-600 dark:text-slate-400">{{ __('Pending Records') }}</div>
                </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-6">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <div class="text-2xl font-bold text-gray-900 dark:text-slate-100">{{ App\Models\BookItem::count() }}</div>
                    <div class="text-sm font-medium text-gray-600 dark:text-slate-400">{{ __('Total Items') }}</div>
                </div>
