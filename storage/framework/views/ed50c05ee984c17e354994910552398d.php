...
<div class="space-y-8 animate-in fade-in duration-700">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-3xl font-extrabold text-slate-900 dark:text-slate-100 tracking-tight"><?php echo e(__('Dashboard')); ?></h1>
                <p class="text-slate-500 dark:text-slate-400 font-medium mt-1"><?php echo e(__('Overview of system activity and statistics')); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 p-6 flex items-center transition-all hover:shadow-md">
            ...
            <div>
                <p class="text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-widest"><?php echo e(__('Total Users')); ?></p>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 p-6 flex items-center transition-all hover:shadow-md">
            ...
            <div>
                <p class="text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-widest"><?php echo e(__('Total Books')); ?></p>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 p-6 flex items-center transition-all hover:shadow-md">
            ...
            <div>
                <p class="text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-widest"><?php echo e(__('Active Loans')); ?></p>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 p-6 flex items-center transition-all hover:shadow-md">
            ...
            <div>
                <p class="text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-widest"><?php echo e(__('Overdue')); ?></p>
    ...
    <div class="bg-white dark:bg-slate-900 shadow-sm rounded-2xl border border-slate-100 dark:border-slate-800 overflow-hidden">
        <div class="px-6 py-5 border-b border-slate-50 dark:border-slate-800 flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/50">
            <h3 class="text-lg font-bold text-slate-800 dark:text-slate-100"><?php echo e(__('User List')); ?></h3>
            <a href="<?php echo e(route('admin.users.index')); ?>" class="text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 uppercase tracking-widest transition-colors"><?php echo e(__('View All')); ?></a>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead>
                    <tr class="bg-slate-50/50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800">
                        <th class="px-6 py-4 text-left text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest"><?php echo e(__('User')); ?></th>
                        <th class="px-6 py-4 text-left text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest"><?php echo e(__('Roles')); ?></th>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest"><?php echo e(__('Joined')); ?></th>
                    </tr>
                </thead>
                    ...
                    <tr class="hover:bg-slate-50/30 dark:hover:bg-slate-800/30 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-bold text-slate-900 dark:text-slate-100"><?php echo e($user->name); ?></div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            ?>
                            <span class="px-2.5 py-1 inline-flex text-xs font-bold uppercase tracking-wider rounded-lg border <?php echo e($color); ?>">
                                <?php echo e(ucfirst($userStatus)); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Workspace\VTTU\Laravel\VTTLib\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>