...
<head>
    ...
    <title><?php echo e(__('Login')); ?> - VTTLib</title>
        ...
        <div class="login-card">
            ...
            <div class="language-switcher" x-data="{ open: false }">
                <button @click="open = !open" class="lang-btn" :class="{ 'active': app()->getLocale() == 'vi' }">
                    <?php echo e(app()->getLocale() == 'vi' ? 'VI' : 'EN'); ?>
                ...
                <div x-show="open" x-cloak
                    ...
                    <a href="<?php echo e(route('lang.switch', 'vi')); ?>" class="lang-btn <?php echo e(app()->getLocale() == 'vi' ? 'active' : ''); ?>">VI</a>
            ...
            <div class="security-badge">
                ...
                <?php echo e(__('Secured by VTTLib')); ?>
            ...
            <div class="login-header">
                ...
                <h1 class="login-title"><?php echo e(__('Hệ thống Quản lý')); ?></h1>
                <p class="login-subtitle"><?php echo e(__('Nhập thông tin định danh để tiếp tục.')); ?></p>
            </div>
            
            <!-- Login Form -->
            <form action="<?php echo e(route('agent.login.store')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input 
                            ...
                            required
                            class="form-input"
                            placeholder="<?php echo e(__('Tên tài khoản')); ?>"
                ...
                <button type="submit" class="submit-btn">
                    ...
                    <?php echo e(__('Đăng nhập hệ thống')); ?>
...
</html><?php /**PATH E:\Workspace\VTTU\Laravel\VTTLib\resources\views/auth/secret_login.blade.php ENDPATH**/ ?>