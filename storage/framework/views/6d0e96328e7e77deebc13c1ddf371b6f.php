...
<div class="space-y-6 w-full pb-20" x-data="catalogWizard()">
    ...
    <div class="flex justify-between items-start bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800">
        <div>
            <h2 class="text-2xl font-bold text-gray-800 dark:text-slate-100"><?php echo e(__('MARC21_Cataloging_Form')); ?></h2>
            <p class="text-sm text-gray-500 dark:text-slate-400 mt-1"><?php echo e(__('Cataloging_Instruction')); ?></p>
        </div>
    ...
    <form id="catalogForm" action="<?php echo e(route('admin.marc.book.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
                    ...
                    <div class="lg:col-span-4">
                        <div class="h-full flex flex-col">
                            <label class="block text-sm font-bold text-gray-700 dark:text-slate-300 mb-3"><?php echo e(__('Cover_Image')); ?></label>
                            <div class="flex-1 min-h-[200px] border-2 border-dashed border-gray-300 dark:border-slate-700 rounded-xl flex flex-col items-center justify-center p-6 bg-gray-50/50 dark:bg-slate-800/50 group hover:border-indigo-500 transition-colors relative overflow-hidden">
                                ...
                                <div class="text-center relative z-0" x-show="!coverPreview">
                                    ...
                                    <p class="text-xs font-bold text-gray-500 dark:text-slate-400 uppercase tracking-widest"><?php echo e(__('Add_Cover_Image')); ?></p>
                                </div>
        ...
        <div x-show="currentStep === 1" x-cloak class="space-y-6">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 overflow-hidden"
                ...
                <div class="p-6" x-show="expanded" x-cloak x-collapse>
                    ...
                    <button type="button" @click="marcFields['<?php echo e($tag->tag); ?>'].subfields.push({ code: '', value: '' })"
                        ...
                        <div class="p-4 bg-indigo-50/30 dark:bg-indigo-900/10 rounded-xl border border-indigo-100 dark:border-indigo-900/30 space-y-4">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" x-model="newItem.waits_for_print" id="create_waits_for_print" class="rounded text-indigo-600 focus:ring-0 w-3 h-3">
                                    <label for="create_waits_for_print" class="ml-1.5 text-[8px] font-bold text-gray-500 uppercase"><?php echo e(__('Wait for print')); ?></label>
                                </div>
                            </div>
        ...
        return {
            ...
            addItem() {
                if (!this.newItem.storage_location_id) {
                    alert('<?php echo e(__("Please select storage location")); ?>');
                    return;
                }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Workspace\VTTU\Laravel\VTTLib\resources\views/admin/marc_books/create.blade.php ENDPATH**/ ?>