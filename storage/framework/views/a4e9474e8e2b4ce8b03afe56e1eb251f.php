...
<div class="min-h-screen bg-slate-50">
    ...
    <section class="bg-blue-900 text-white py-20 relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <h1 class="text-4xl md:text-6xl font-black mb-4"><?php echo e($node->display_name); ?></h1>
            <p class="text-xl text-blue-200 max-w-2xl"><?php echo e($node->description ?? 'Tìm hiểu về sứ mệnh và giá trị cốt lõi của chúng tôi.'); ?></p>
        </div>
    </section>
