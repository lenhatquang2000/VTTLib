...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            <h1 class="text-2xl font-bold"><?php echo e(__('Page Builder')); ?></h1>
            <p class="text-sm text-gray-400 mt-1"><?php echo e(__('Xây dựng trang: ')); ?><?php echo e($siteNode->display_name); ?></p>
        </div>
        <div class="flex gap-2">
            <a href="<?php echo e(route('admin.site-nodes.edit', $siteNode)); ?>" class="btn-secondary">
                <i class="fas fa-arrow-left mr-2"></i><?php echo e(__('Quay lại Edit')); ?>

            </a>
            <a href="<?php echo e(route('admin.site-nodes.index', ['language' => $siteNode->language])); ?>" class="btn-secondary">
                <i class="fas fa-list mr-2"></i><?php echo e(__('Danh sách')); ?>
    ...
    <div class="card-admin p-6">
        <form id="pageBuilderForm" action="<?php echo e(route('admin.site-nodes.page-builder.update', $siteNode)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="flex gap-6">
                ...
                <div class="w-80 flex-shrink-0">
                    <div class="bg-gray-800 border border-gray-600 rounded-lg p-4">
                        ...
                        <div class="space-y-2">
                            <?php $__currentLoopData = App\Models\SiteNodeItem::getAvailableTypes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="available-item bg-gray-700 hover:bg-gray-600 border border-gray-600 rounded-lg p-3 cursor-move transition-colors"
                                 data-item-type="<?php echo e($type); ?>"
                                 draggable="true"
                                 ondragstart="handleDragStart(event)">
                                <div class="flex items-center">
                                    <i class="fas fa-grip-vertical text-gray-400 mr-3"></i>
                                    <div>
                                        <div class="font-medium text-sm text-gray-100"><?php echo e($label); ?></div>
                                        <div class="text-xs text-gray-400"><?php echo e($itemTypeDescriptions[$type] ?? 'Custom content block'); ?></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="items-canvas" 
                        ...
                        <?php if(!empty($items)): ?>
                            ...
                            <div class="canvas-item mb-4 p-4 bg-gray-800 border border-gray-700 rounded-lg" 
                                 ...
                                 data-item-type="<?php echo e($itemType); ?>"
                                 data-item-data="<?php echo e(json_encode($itemData)); ?>"
                                 draggable="true"
                                ...
                                <div class="flex items-start justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="font-medium text-sm text-gray-100"><?php echo e(App\Models\SiteNodeItem::getAvailableTypes()[$itemType] ?? $itemType); ?></div>
                                            <div class="text-xs text-gray-400 mt-1">
                                                <?php echo e($previewText); ?>

                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <button type="button" onclick="editItem('<?php echo e($itemId); ?>')" class="text-blue-600 hover:text-blue-400">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button type="button" onclick="deleteItem('<?php echo e($itemId); ?>')" class="text-red-600 hover:text-red-400">
            ...
            <div class="flex justify-end gap-2 mt-6 pt-6 border-t border-gray-700">
                <a href="<?php echo e(route('admin.site-nodes.edit', $siteNode)); ?>" 
                   class="btn-secondary">
                    Hủy
                </a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Workspace\VTTU\Laravel\VTTLib\resources\views/admin/site-nodes/page-builder.blade.php ENDPATH**/ ?>