                                                    ...
                                                    <div class="border-l-2 border-blue-400 pl-2 mb-2">
                                                        ...
                                                        <?php $__currentLoopData = $value; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $change): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <p class="text-xs text-gray-600 dark:text-gray-400 mb-1">
                                                                ...
                                                                <span class="line-through text-red-500"><?php echo e(is_array($change['old'] ?? null) ? json_encode($change['old']) : ($change['old'] ?? 'N/A')); ?></span>
                                                                <span class="mx-1">→</span>
                                                                <span class="text-green-600"><?php echo e(is_array($change['new'] ?? null) ? json_encode($change['new']) : ($change['new'] ?? 'N/A')); ?></span>
                                                            </p>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </div>
                                                <?php elseif(is_array($value)): ?>
                                                    <p class="text-xs"><span class="font-medium"><?php echo e($key); ?>:</span> <?php echo e(json_encode($value)); ?></p>
                                                <?php else: ?>
