...
<?php $__env->startSection('content'); ?>
    ...
    <div class="flex items-center space-x-2 p-1.5 bg-slate-100 dark:bg-slate-900 rounded-[2rem] w-fit border border-slate-200 dark:border-slate-800">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center p-6 bg-white dark:bg-slate-800 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-700 gap-4">
            <div>
                <h2 class="text-xl font-bold text-slate-900 dark:text-white"><?php echo e(__('Role_Template_Management')); ?></h2>
                <p class="text-sm text-slate-500 mt-1"><?php echo e(__('Define and manage system access levels.')); ?></p>
            </div>
            <div class="flex flex-wrap gap-3">
                ...
                <a href="<?php echo e(route('admin.roles.create')); ?>"
                    ...
                    <?php echo e(__('Initialize_New_Role')); ?>
                ...
                <table class="w-full text-sm text-left">
                    <thead>
                        <tr class="bg-slate-50 dark:bg-slate-900/50 text-slate-500 dark:text-slate-400 border-b border-slate-200 dark:border-slate-700 uppercase text-[10px] font-black tracking-widest">
                            <th class="p-5"><?php echo e(__('ID')); ?></th>
                            <th class="p-5"><?php echo e(__('Role_Identity')); ?></th>
                            <th class="p-5"><?php echo e(__('Assigned_Subjects')); ?></th>
                            <th class="p-5"><?php echo e(__('Default_Tabs')); ?></th>
                            <th class="p-5 text-right"><?php echo e(__('Operations')); ?></th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-700/50">
                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition">
                                <td class="p-5 font-mono text-xs text-slate-400">#<?php echo e(str_pad($role->id, 3, '0', STR_PAD_LEFT)); ?></td>
                                <td class="p-5">
                                    <div class="text-slate-900 dark:text-white font-bold"><?php echo e($role->display_name); ?></div>
                                    <div class="text-[10px] text-slate-500 font-bold tracking-wider uppercase mt-1"><?php echo e($role->name); ?></div>
                                </td>
                                <td class="p-5">
                                ...
                                <td class="p-5">
                                    <div class="flex flex-wrap gap-1.5 ">
                                        ...
                                        <?php if($role->sidebars->count() > 5): ?>
                                            <span class="text-slate-400 text-[10px] font-black self-center ml-1">+<?php echo e($role->sidebars->count() - 5); ?> More</span>
                                        <?php endif; ?>
