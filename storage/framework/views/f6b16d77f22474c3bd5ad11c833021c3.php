<?php $__env->startSection('title', $news->title . ' - VTTLib'); ?>
            ...
            <article class="lg:col-span-8">
                <div class="bg-white rounded-[2.5rem] shadow-xl shadow-black/5 border border-slate-100 overflow-hidden">
                    ...
                    <div class="aspect-video w-full overflow-hidden">
                        <img src="<?php echo e($news->featured_image); ?>" alt="<?php echo e($news->title); ?>" class="w-full h-full object-cover">
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="p-8 md:p-12">
                        ...
                        <div class="flex flex-wrap items-center gap-4 mb-6">
                            ...
                            <div class="flex items-center text-slate-400 text-sm font-bold">
                                ...
                                <?php echo e(number_format($news->view_count)); ?> lượt xem
                            </div>
                        </div>
                        ...
                        <div class="mt-12 pt-8 border-t border-slate-100 flex flex-wrap gap-2">
                            ...
                            <a href="<?php echo e(route('news.tag', $tag->slug)); ?>" class="px-4 py-2 bg-slate-100 hover:bg-vttu-red hover:text-white text-slate-600 text-xs font-bold rounded-xl transition-all">
                                #<?php echo e($tag->name); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                    <?php if(isset($previousNews) && $previousNews): ?>
                    <a href="<?php echo e($previousNews->url); ?>" class="p-6 bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl transition-all group">
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-2">Bài trước</span>
                        <h4 class="text-vttu-dark font-bold group-hover:text-vttu-red transition-colors line-clamp-1"><?php echo e($previousNews->title); ?></h4>
                    </a>
                    <?php endif; ?>
                    <?php if(isset($nextNews) && $nextNews): ?>
                    <a href="<?php echo e($nextNews->url); ?>" class="p-6 bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl transition-all group text-right">
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-2">Bài tiếp theo</span>
                        <h4 class="text-vttu-dark font-bold group-hover:text-vttu-red transition-colors line-clamp-1"><?php echo e($nextNews->title); ?></h4>
                    </a>
                    <?php endif; ?>
                </div>
            </article>
            ...
            <aside class="lg:col-span-4 space-y-8">
                ...
                <div class="bg-white rounded-[2rem] p-8 shadow-xl shadow-black/5 border border-slate-100">
                    ...
                    <div class="space-y-6">
                        ...
                        <a href="<?php echo e($item->url); ?>" class="flex gap-4 group">
                            <div class="w-20 h-20 bg-slate-100 rounded-2xl flex-shrink-0 overflow-hidden">
                                <img src="<?php echo e($item->featured_image ?? 'https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?auto=format&fit=crop&w=200&q=80'); ?>" 
                                     class="w-full h-full object-cover group-hover:scale-110 transition-transform">
                            </div>
                            <div class="flex-1">
                                <h4 class="text-sm font-bold text-vttu-dark group-hover:text-vttu-red transition-colors line-clamp-2 leading-snug"><?php echo e($item->title); ?></h4>
...
<?php echo $__env->make('layouts.site', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Workspace\VTTU\Laravel\VTTLib\resources\views/site/pages/news-show.blade.php ENDPATH**/ ?>