...
<div class="space-y-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            <h1 class="text-2xl font-bold"><?php echo e(__('Loan Desk')); ?></h1>
            <p class="text-sm text-gray-400 mt-1"><?php echo e(__('Circulation Management - Loan, Return, Reading Room, Hold')); ?></p>
        </div>
        <div class="flex gap-2">
            <a href="<?php echo e(route('admin.circulation.reports.index')); ?>" class="btn-secondary">
                <i class="fas fa-chart-bar mr-2"></i><?php echo e(__('Reports')); ?>

            </a>
            <a href="<?php echo e(route('admin.circulation.tools')); ?>" class="btn-secondary">
                <i class="fas fa-tools mr-2"></i><?php echo e(__('Tools')); ?>

            </a>
            <a href="<?php echo e(route('admin.circulation.policies.index')); ?>" class="btn-secondary">
                <i class="fas fa-cog mr-2"></i><?php echo e(__('Policies')); ?>
        ...
        <div class="p-6">
            ...
            <div id="checkoutContent" class="space-y-6">
                <div class="flex justify-end mb-2">
                    <button type="button" onclick="window.location.reload()" class="text-xs text-gray-400 hover:text-white transition-colors flex items-center gap-1">
                        <i class="fas fa-sync-alt"></i> <?php echo e(__('Tải lại trang')); ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <?php echo $__env->make('admin.circulation.components.patron-info', ['id' => 'patronInfo'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php echo $__env->make('admin.circulation.components.book-info', ['id' => 'bookSearchResult'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
            </div>
            ...
            <div id="checkinContent" class="space-y-6 hidden">
                <div class="flex justify-end mb-2">
                    <button type="button" onclick="loadPatronActiveLoans()" class="text-xs text-gray-400 hover:text-white transition-colors flex items-center gap-1">
                        <i class="fas fa-sync-alt"></i> <?php echo e(__('Tải lại danh sách')); ?>
            ...
            <div id="readingRoomContent" class="space-y-6 hidden">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        <h3 class="text-lg font-bold mb-4 text-purple-400"><?php echo e(__('Mượn đọc tại chỗ')); ?></h3>
                        <form id="readingRoomForm" class="space-y-4">
                            ...
                            <div class="relative">
                                ...
                                <div class="relative">
                                    <input type="text" id="reading_patron_code" name="patron_code" required class="input-field w-full pr-10" 
                                        placeholder="<?php echo e(__('Scan_or_enter_patron_code')); ?>" onchange="loadReadingRoomTransactions()">
                            ...
                            <div>
                                <label class="block text-sm font-medium mb-1"><?php echo e(__('Ghi chú')); ?></label>
                                <textarea id="reading_notes" name="notes" rows="2" class="input-field w-full" 
                                    placeholder="<?php echo e(__('Nhập ghi chú (không bắt buộc)')); ?>"></textarea>
                            </div>
                            <button type="button" onclick="processReadingRoomCheckout()" 
                                ...
                                <i class="fas fa-book-reader mr-2"></i><?php echo e(__('Mượn đọc tại chỗ')); ?>
                    ...
                    <div>
                        <?php echo $__env->make('admin.circulation.components.patron-info', ['id' => 'readingPatronInfo'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php echo $__env->make('admin.circulation.components.book-info', ['id' => 'readingBookInfo'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        
                        <h3 class="text-lg font-bold mb-4 text-purple-400"><?php echo e(__('Tài liệu đang mượn đọc')); ?></h3>
                        <div id="readingRoomTransactions" class="card-admin p-4 min-h-[300px]">
                            <div class="text-center text-gray-500 py-8">
                                <svg class="w-12 h-12 mx-auto mb-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                                </svg>
                                <p class="text-sm"><?php echo e(__('Nhập mã bạn đọc để xem tài liệu đang mượn đọc')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            <button type="button" onclick="processReadingRoomCheckin()" 
                                ...
                                <i class="fas fa-undo mr-2"></i><?php echo e(__('Trả các tài liệu đã chọn')); ?>
                ...
                <div class="mt-6">
                    <h3 class="text-lg font-bold mb-4 text-purple-400"><?php echo e(__('Tất cả tài liệu đang mượn đọc')); ?></h3>
                    <div id="allReadingRoomTransactions" class="card-admin p-4">
                        <div class="text-center text-gray-500 py-4">
                            <p class="text-sm"><?php echo e(__('Đang tải danh sách...')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="holdContent" class="space-y-6 hidden">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        <h3 class="text-lg font-bold mb-4 text-orange-400"><?php echo e(__('Giữ lại sách (Hold/Reserve)')); ?></h3>
                        <form id="holdForm" class="space-y-4">
                            ...
                            <div class="relative">
                                ...
                                <div class="relative">
                                    <input type="text" id="hold_patron_code" name="patron_code" required class="input-field w-full pr-10" 
                                        placeholder="<?php echo e(__('Scan_or_enter_patron_code')); ?>" onchange="loadPatronReservations()">
                            ...
                            <button type="button" onclick="processPlaceHold()" 
                                ...
                                <i class="fas fa-bookmark mr-2"></i><?php echo e(__('Giữ lại sách')); ?>
                    ...
                    <div>
                        <?php echo $__env->make('admin.circulation.components.patron-info', ['id' => 'holdPatronInfo'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        
                        <h3 class="text-lg font-bold mb-4 text-orange-400"><?php echo e(__('Reservations đang hoạt động')); ?></h3>
                        <div id="patronReservations" class="card-admin p-4 min-h-[300px]">
                            <div class="text-center text-gray-500 py-8">
                                <svg class="w-12 h-12 mx-auto mb-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path>
                                </svg>
                                <p class="text-sm"><?php echo e(__("Nhập mã bạn đọc để xem reservations")); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    <h3 class="text-lg font-bold mb-4 text-orange-400"><?php echo e(__('Tất cả Reservations đang hoạt động')); ?></h3>
            ...
            <div id="borrowedContent" class="space-y-6 hidden">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-bold text-indigo-400"><?php echo e(__('Danh sách sách đang được mượn')); ?></h3>
                    <div class="flex items-center gap-4">
                        <button type="button" onclick="window.location.href='<?php echo e(route('admin.circulation.loan-desk')); ?>?tab=borrowed'" class="text-xs text-gray-400 hover:text-white transition-colors flex items-center gap-1">
                            <i class="fas fa-sync-alt"></i> <?php echo e(__('Tải lại')); ?>

                        </button>
                        <span class="bg-indigo-900/50 text-indigo-400 px-3 py-1 rounded-full text-xs font-bold">
                            <?php echo e($activeLoans->count()); ?> <?php echo e(__('cuốn sách')); ?>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            <thead class="bg-gray-800 text-xs uppercase text-gray-400">
                                <tr>
                                    <th class="p-3 text-left"><?php echo e(__('Mã vạch')); ?></th>
                                    <th class="p-3 text-left"><?php echo e(__('Tên sách')); ?></th>
                                    <th class="p-3 text-left"><?php echo e(__('Người mượn')); ?></th>
                                    <th class="p-3 text-left"><?php echo e(__('Ngày mượn')); ?></th>
                                    <th class="p-3 text-left"><?php echo e(__('Hạn trả')); ?></th>
                                    <th class="p-3 text-left text-center"><?php echo e(__('Trạng thái')); ?></th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-800/50 transition-colors">
                                    <td class="p-3 font-mono text-blue-400 text-xs"><?php echo e($loan->bookItem->barcode); ?></td>
                                    <td class="p-3 font-medium text-gray-200"><?php echo e($loan->bookItem->bibliographicRecord->title ?? 'N/A'); ?></td>
                                    <td class="p-3">
                                        <div class="font-medium text-gray-300"><?php echo e($loan->patron->display_name ?? $loan->patron->user->name ?? 'N/A'); ?></div>
                                        <div class="text-[10px] text-gray-500 font-mono"><?php echo e($loan->patron->patron_code); ?></div>
                                    </td>
                                    <td class="p-3 text-xs text-gray-400">
                                        <?php echo e($loan->loan_date ? $loan->loan_date->format('d/m/Y H:i') : '-'); ?>

                                    </td>
                                    <td class="p-3 text-xs <?php echo e($loan->isOverdue() ? 'text-rose-500 font-bold' : 'text-gray-400'); ?>">
                                        <?php echo e($loan->due_date ? $loan->due_date->format('d/m/Y') : '-'); ?>
                                ...
                                <tr>
                                    <td colspan="6" class="p-12 text-center text-gray-500 italic">
                                        <?php echo e(__('Không có sách nào đang được mượn.')); ?>
            ...
            <div id="requestsContent" class="space-y-6 hidden">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-bold text-amber-400"><?php echo e(__('Yêu cầu mượn sách đang chờ')); ?></h3>
                    <div class="flex items-center gap-4">
                        <button type="button" onclick="window.location.href='<?php echo e(route('admin.circulation.loan-desk')); ?>?tab=requests'" class="text-xs text-gray-400 hover:text-white transition-colors flex items-center gap-1">
                            <i class="fas fa-sync-alt"></i> <?php echo e(__('Tải lại')); ?>

                        </button>
                        <div class="flex gap-2">
                            <span class="bg-amber-900/50 text-amber-400 px-3 py-1 rounded-full text-xs font-bold">
                                <?php echo e($loanRequests->where('status', 'pending')->count()); ?> <?php echo e(__('đang chờ')); ?>

                            </span>
                            <span class="bg-emerald-900/50 text-emerald-400 px-3 py-1 rounded-full text-xs font-bold">
                                <?php echo e($loanRequests->where('status', 'ready')->count()); ?> <?php echo e(__('sẵn sàng')); ?>
                ...
                <div class="card-admin rounded-lg overflow-hidden border border-gray-700">
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            <thead class="bg-gray-800 text-xs uppercase text-gray-400">
                                <tr>
                                    <th class="p-3 text-left"><?php echo e(__('Độc giả')); ?></th>
                                    <th class="p-3 text-left"><?php echo e(__('Tài liệu yêu cầu')); ?></th>
                                    <th class="p-3 text-left"><?php echo e(__('Ngày đăng ký')); ?></th>
                                    <th class="p-3 text-center"><?php echo e(__('Trạng thái')); ?></th>
                                    <th class="p-3 text-right"><?php echo e(__('Thao tác')); ?></th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-700">
                                <?php $__empty_1 = true; $__currentLoopData = $loanRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                ...
                                <tr class="hover:bg-gray-800/50 transition-colors">
                                    <td class="p-3">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p class="text-xs font-bold text-gray-200"><?php echo e($req->patron->display_name ?? $req->patron->user->name); ?></p>
                                                <p class="text-[10px] text-gray-500 font-mono"><?php echo e($req->patron->patron_code); ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-3">
                                        <div class="max-w-xs">
                                            <p class="text-xs font-bold text-gray-300 line-clamp-1" title="<?php echo e($reqTitle); ?>"><?php echo e($reqTitle); ?></p>
                                            <p class="text-[10px] text-gray-500">Record ID: #<?php echo e($req->bibliographic_record_id); ?></p>
                                        </div>
                                    </td>
                                    <td class="p-3 text-xs text-gray-400">
                                        <?php echo e($req->reservation_date->format('d/m/Y H:i')); ?>
                                        ...
                                        <?php elseif($req->status == 'ready'): ?>
                                            <div class="flex flex-col items-center">
                                                ...
                                                <?php if($req->expiry_date): ?>
                                                    ...
                                                    ?>
                                                    <span class="text-[9px] mt-1 <?php echo e($isExpiringSoon ? 'text-rose-400 animate-pulse font-bold' : 'text-gray-400'); ?>">
                                                        <i class="fas fa-clock mr-1"></i>
                                                        <?php if($daysLeft > 0): ?>
                                                            <?php echo e(__('Còn :days ngày', ['days' => ceil($daysLeft)])); ?>

                                                        <?php else: ?>
                                                            <?php echo e(__('Hết hạn hôm nay')); ?>
                                    ...
                                    <td class="p-3 text-right">
                                        <div class="flex justify-end gap-2">
                                            <?php if($req->status == 'pending'): ?>
                                                <button onclick="approveLoanRequest(<?php echo e($req->id); ?>)" class="w-8 h-8 flex items-center justify-center bg-emerald-900/30 text-emerald-400 hover:bg-emerald-600 hover:text-white rounded-lg transition-all border border-emerald-500/30" title="<?php echo e(__('Phê duyệt')); ?>">
                                                    <i class="fas fa-check text-xs"></i>
                                                </button>
                                                <button onclick="openRejectLoanModal(<?php echo e($req->id); ?>)" class="w-8 h-8 flex items-center justify-center bg-rose-900/30 text-rose-400 hover:bg-rose-600 hover:text-white rounded-lg transition-all border border-rose-500/30" title="<?php echo e(__('Từ chối')); ?>">
                                                    <i class="fas fa-times text-xs"></i>
                                                </button>
                                            <?php elseif($req->status == 'ready'): ?>
                                                <button onclick="fulfillReservation(<?php echo e($req->id); ?>)" class="w-8 h-8 flex items-center justify-center bg-blue-900/30 text-blue-400 hover:bg-blue-600 hover:text-white rounded-lg transition-all border border-blue-500/30" title="<?php echo e(__('Cho mượn')); ?>">
                                                    <i class="fas fa-hand-holding text-xs"></i>
                                                </button>
                                                <button onclick="openRejectLoanModal(<?php echo e($req->id); ?>)" class="w-8 h-8 flex items-center justify-center bg-rose-900/30 text-rose-400 hover:bg-rose-600 hover:text-white rounded-lg transition-all border border-rose-500/30" title="<?php echo e(__('Hủy yêu cầu')); ?>">
                                                    <i class="fas fa-times text-xs"></i>
                                                </button>
                                            <?php endif; ?>
                                        </div>
                                ...
                                <tr>
                                    <td colspan="5" class="p-12 text-center text-gray-500 italic">
                                        ...
                                        <p><?php echo e(__('Không có yêu cầu mượn nào.')); ?></p>
                                    </td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
                    ...
                    <tr class="hover:bg-gray-800/50">
                        ...
                        <td class="p-3">
                            <div class="flex space-x-2">
                                ...
                                <button onclick="recallLoanTransaction('<?php echo e($loan->bookItem->barcode); ?>', '<?php echo e($loan->bookItem->bibliographicRecord->title); ?>')" 
                                ...
                                <button onclick="declareLostLoanTransaction('<?php echo e($loan->bookItem->barcode); ?>', '<?php echo e($loan->bookItem->bibliographicRecord->title); ?>')" 
    ...
    <div class="card-admin rounded-lg overflow-hidden">
        <div class="p-4 border-b border-gray-700">
            <h3 class="text-lg font-bold"><?php echo e(__("Hành động gần đây")); ?></h3>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                <thead class="bg-gray-800 text-xs uppercase">
...
const lockHistoryData = <?php echo json_encode($allLockHistory ?? [], 15, 512) ?>;
const loanTransactionsData = <?php echo json_encode($allLoanTransactions ?? [], 15, 512) ?>;
            ...
            if (infoDiv) {
                infoDiv.innerHTML = `
                    <div class="text-center text-gray-500 text-sm py-8">
                        ...
                        <p><?php echo e(__('Nhập mã bạn đọc để hiển thị thông tin')); ?></p>
                    </div>
                `;
            }
        }
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-400 mt-1">
                                <?php echo e(__("Barcode")); ?>: <span class="font-mono text-blue-400">${book.data.barcode}</span>
                            </p>
                            <div class="mt-2">
                    ...
                    <div class="bg-gray-700/30 rounded-lg p-3 space-y-2">
                        <div class="flex justify-between">
                            <span class="text-gray-400 text-sm"><?php echo e(__("Author")); ?>:</span>
                            <span class="text-white text-sm">${book.data.author || '<?php echo e(__("N/A")); ?>'}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-400 text-sm"><?php echo e(__("Call Number")); ?>:</span>
                            <span class="text-white text-sm font-mono">${book.data.call_number || '<?php echo e(__("N/A")); ?>'}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-400 text-sm"><?php echo e(__("Status")); ?>:</span>
                    ...
                    <div class="bg-blue-900/20 border border-blue-700/50 rounded-lg p-3">
                        <h5 class="text-sm font-semibold text-blue-400 mb-2"><?php echo e(__("Current_Loan_Information")); ?></h5>
                        <div class="space-y-2">
                            <div class="flex justify-between">
                                <span class="text-gray-400 text-sm"><?php echo e(__("On_loan_to")); ?>:</span>
                                <span class="text-white text-sm font-medium">${book.data.current_loan?.patron_name || 'N/A'}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-400 text-sm"><?php echo e(__("Patron_Code")); ?>:</span>
                                <span class="text-white text-sm font-mono">${book.data.current_loan?.patron_code || 'N/A'}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-400 text-sm"><?php echo e(__("Due_Date")); ?>:</span>
                            ...
                            ${book.data.current_loan?.is_overdue ? `
                                <div class="flex justify-between">
                                    <span class="text-gray-400 text-sm"><?php echo e(__("Overdue_Days")); ?>:</span>
                                    <span class="text-red-400 text-sm font-bold">${book.data.current_loan.overdue_days} <?php echo e(__("days")); ?></span>
                                </div>
                            ` : ''}
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <div class="text-green-400 text-sm"><i class="fas fa-check-circle mr-1"></i> <?php echo e(__("Ready_for_checkin")); ?></div>
                    </div>
                </div>
            `;
        } else {
            ...
            infoDiv.innerHTML = `
                <div class="text-center py-8">
                    ...
                    <p class="text-green-400 text-sm">
                        <i class="fas fa-info-circle mr-1"></i> <?php echo e(__("This_book_is_already_available")); ?>
...
function displayCheckinBookError() {
    ...
    infoDiv.innerHTML = `
        <div class="text-center text-red-400 py-8">
            ...
            <p class="text-sm"><?php echo e(__("Search_Error")); ?></p>
        </div>
    `;
}
            ...
            infoDiv.innerHTML = `
                <div class="space-y-4">
                    ...
                    <div class="flex items-start space-x-4 pb-4 border-b border-gray-600">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="grid grid-cols-2 gap-3 text-sm">
                                <div>
                                    <span class="text-gray-400"><?php echo e(__("Số sách đang mượn")); ?>:</span>
                                    <span class="text-white font-medium ml-1">${loans}</span>
                                </div>
                                <div>
                                    <span class="text-gray-400"><?php echo e(__("Phí chưa trả")); ?>:</span>
                    ...
                    <div class="bg-gray-700/30 rounded-lg p-3 text-sm">
                        <h5 class="text-xs font-semibold text-gray-300 mb-2"><?php echo e(__("Lịch sử giao dịch")); ?></h5>
                        <div class="grid grid-cols-3 gap-2 text-center">
                            <div>
                                <div class="text-blue-400 font-bold text-lg">${patron.data.transaction_stats?.total_checkouts || 0}</div>
                                <div class="text-gray-400 text-xs"><?php echo e(__("Đã mượn")); ?></div>
                            </div>
                            <div>
                                <div class="text-green-400 font-bold text-lg">${patron.data.transaction_stats?.total_checkins || 0}</div>
                                <div class="text-gray-400 text-xs"><?php echo e(__("Đã trả")); ?></div>
                            </div>
                            <div>
                                <div class="text-orange-400 font-bold text-lg">${patron.data.transaction_stats?.total_renewals || 0}</div>
                                <div class="text-gray-400 text-xs"><?php echo e(__("Gia hạn")); ?></div>
                            </div>
                        </div>
                        <div class="mt-2 pt-2 border-t border-gray-600">
                            <div class="flex justify-between">
                                <span class="text-gray-400 text-xs"><?php echo e(__("Tổng giao dịch")); ?>:</span>
                    ...
                    ${loans > 0 ? `
                        <div class="bg-gray-700/30 rounded-lg p-3">
                            <h5 class="text-xs font-semibold text-gray-300 mb-2"><?php echo e(__("Tài liệu đang mượn")); ?> (${loans})</h5>
                            <div class="overflow-x-auto">
                                <table class="current-loans-table w-full">
                                    <thead>
                                        <tr class="border-b border-gray-600">
                                            <th class="text-left text-gray-400 pb-1"><?php echo e(__("Mã vạch")); ?></th>
                                            <th class="text-left text-gray-400 pb-1"><?php echo e(__("Tên tài liệu")); ?></th>
                                            <th class="text-left text-gray-400 pb-1"><?php echo e(__("Hết hạn")); ?></th>
                                            <th class="text-right text-gray-400 pb-1"><?php echo e(__("Hành động")); ?></th>
                                        </tr>
                                    </thead>
            ...
            infoDiv.innerHTML = `
                <div class="p-3 rounded-lg border bg-red-900/20 border-red-700/50">
                    <div class="flex items-center">
                        ...
                        <span class="text-sm text-red-400">${patron.message || '<?php echo e(__("Không tìm thấy bạn đọc")); ?>'}</span>
                    </div>
                </div>
            `;
        }
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-500 mt-1">
                            ${book.data.author || '<?php echo e(__("N/A")); ?>'} • ${book.data.call_number || '<?php echo e(__("N/A")); ?>'}
                        </p>
                        ${book.data.current_loan ? `<p class="text-xs text-orange-600 dark:text-orange-400 mt-1"><?php echo e(__("On_loan_to")); ?>: ${book.data.current_loan.patron_name}</p>` : ''}
                    </div>
    ...
    <div class="bg-gray-800 rounded-lg p-6 w-full max-w-md mx-4">
        <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-semibold text-white flex items-center">
                ...
                <?php echo e(__("Triệu hồi tài liệu")); ?>
        ...
        <div class="space-y-4">
            <div>
                <label class="block text-sm font-medium text-gray-300 mb-1"><?php echo e(__("Mã vạch tài liệu")); ?> *</label>
                <input type="text" id="recallBookBarcode" class="input-field w-full" placeholder="<?php echo e(__("Nhập mã vạch tài liệu cần triệu hồi")); ?>">
            </div>
            
            <div>
                <label class="block text-sm font-medium text-gray-300 mb-1"><?php echo e(__("Lý do triệu hồi")); ?></label>
                <textarea id="recallReason" class="input-field w-full" rows="3" placeholder="<?php echo e(__("Nhập lý do triệu hồi (không bắt buộc)")); ?>"></textarea>
            </div>
    ...
    <div class="bg-gray-800 rounded-lg p-6 w-full max-w-md mx-4">
        <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-semibold text-white flex items-center">
                ...
                <?php echo e(__("Khai báo mất tài liệu")); ?>
        ...
        <div class="space-y-4">
            <div>
                <label class="block text-sm font-medium text-gray-300 mb-1"><?php echo e(__("Chọn tài liệu")); ?> *</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-300 mb-1"><?php echo e(__("Ghi chú")); ?></label>
                <textarea id="declareLostNotes" class="input-field w-full" rows="3" placeholder="<?php echo e(__("Nhập ghi chú (không bắt buộc)")); ?>"></textarea>
            </div>
...
function loadCurrentLoans(patronId) {
    ...
    if (patronLoans.length === 0) {
        tbody.innerHTML = `
            <tr>
                <td colspan="4" class="text-center text-gray-400 py-2">
                    <?php echo e(__("Không có tài liệu nào đang mượn")); ?>
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            Swal.fire({
                ...
                text: `<?php echo e(__("Khai báo mất tài liệu thành công")); ?>: ${title}`,
                confirmButtonColor: '#3b82f6'
            });
...
function loadPatronBooksForDeclareLost() {
    ...
    fetch(`<?php echo e(route('admin.circulation.search-patron')); ?>?patron_code=${encodeURIComponent(patronCode)}`)
        .then(response => response.json())
        .then(data => {
            if (data.success && data.data.current_loans > 0) {
                ...
                document.getElementById('declareLostBooksList').innerHTML = `
                    <div class="text-gray-400 text-sm text-center py-4">
                        <?php echo e(__("Bạn đọc không có tài liệu đang mượn")); ?>
...
function processRecall() {
    ...
    if (!barcode) {
        Swal.fire({
            ...
            text: '<?php echo e(__("Vui lòng nhập mã vạch tài liệu")); ?>',
            confirmButtonColor: '#3b82f6'
        });
        return;
    }
    ...
    Swal.fire({
        ...
        text: '<?php echo e(__("Đang triệu hồi tài liệu...")); ?>',
    ...
    .catch(error => {
        ...
        Swal.fire({
            icon: 'error',
            title: '<?php echo e(__("Lỗi")); ?>',
            text: '<?php echo e(__("Có lỗi xảy ra khi triệu hồi tài liệu")); ?>',
            confirmButtonColor: '#3b82f6'
        });
    });
}
...
function processDeclareLost() {
    ...
    if (checkboxes.length === 0) {
        Swal.fire({
            icon: 'warning',
            title: '<?php echo e(__("Thông báo")); ?>',
            text: '<?php echo e(__("Vui lòng chọn ít nhất một tài liệu")); ?>',
            confirmButtonColor: '#3b82f6'
        });
        return;
    }
    ...
    Swal.fire({
        icon: 'success',
        title: '<?php echo e(__("Thành công")); ?>',
        text: '<?php echo e(__("Khai báo mất tài liệu thành công")); ?>',
        confirmButtonColor: '#3b82f6'
    });
...
function declareLostLoanTransaction(barcode, title) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            Swal.fire({
                title: '<?php echo e(__("Đang xử lý")); ?>',
                text: '<?php echo e(__("Đang khai báo mất tài liệu...")); ?>',
                allowOutsideClick: false,
                didOpen: () => {
                    Swal.showLoading();
                }
            ...
            .catch(error => {
                ...
                Swal.fire({
                    icon: 'error',
                    title: '<?php echo e(__("Lỗi")); ?>',
                    text: '<?php echo e(__("Có lỗi xảy ra khi khai báo mất tài liệu")); ?>',
                    confirmButtonColor: '#3b82f6'
                });
            });
        }
...
function addRecentAction(action) {
    ...
    const statusText = action.type === 'declare_lost' ? '<?php echo e(__("Đã khai báo mất")); ?>' : 
                      action.type === 'recall' ? '<?php echo e(__("Đã triệu hồi")); ?>' : 
                      action.status;
    ...
    newRow.innerHTML = `
        ...
        <td class="p-3">
            <span class="text-xs text-gray-500"><?php echo e(__("Hoàn thành")); ?></span>
        </td>
    `;
...
function processReadingRoomCheckout() {
    ...
    if (!patronCode || !bookBarcode) {
        Swal.fire({
            icon: 'warning',
            title: '<?php echo e(__("Thông báo")); ?>',
            text: '<?php echo e(__("Vui lòng nhập mã bạn đọc và mã tài liệu")); ?>',
            confirmButtonColor: '#3b82f6'
        });
        return;
    }
    ...
    Swal.fire({
        title: '<?php echo e(__("Đang xử lý")); ?>',
        text: '<?php echo e(__("Đang xử lý mượn đọc...")); ?>',
        allowOutsideClick: false,
        didOpen: () => {
            Swal.showLoading();
        }
    ...
    // Make API call
    fetch('<?php echo e(route("admin.circulation.reading-room.checkout")); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        if (data.success) {
            Swal.fire({
                ...
                html: `
                    ${data.message}<br><br>
                    <small>
                        <strong><?php echo e(__("Bạn đọc")); ?>:</strong> ${data.data.patron_name}<br>
                        <strong><?php echo e(__("Tài liệu")); ?>:</strong> ${data.data.book_title}<br>
                        <strong><?php echo e(__("Hạn trả")); ?>:</strong> ${data.data.due_time}
                    </small>
                `,
                confirmButtonColor: '#3b82f6'
            });
    ...
    .catch(error => {
        ...
        Swal.fire({
            icon: 'error',
            title: '<?php echo e(__("Lỗi")); ?>',
            text: '<?php echo e(__("Có lỗi xảy ra. Vui lòng thử lại.")); ?>',
            confirmButtonColor: '#3b82f6'
        });
    });
}
...
function loadReadingRoomTransactions() {
    ...
    fetch(`<?php echo e(route("admin.circulation.reading-room.transactions")); ?>?patron_code=${patronCode}`)
        .then(response => response.json())
        .then(data => {
            if (data.success) {
        ...
        .catch(error => {
            ...
            document.getElementById('readingRoomTransactions').innerHTML = `
                <div class="text-center text-red-400 py-4">
                    <p class="text-sm"><?php echo e(__("Có lỗi xảy ra khi tải danh sách")); ?></p>
                </div>
            `;
            document.getElementById('returnReadingRoomBtn').disabled = true;
        });
...
function displayReadingRoomTransactions(data) {
    ...
    if (data.transactions.length === 0) {
        container.innerHTML = `
            <div class="text-center text-gray-500 py-8">
                ...
                <p class="text-sm"><?php echo e(__("Bạn đọc không có tài liệu nào đang mượn đọc")); ?></p>
            </div>
        `;
    ...
    let html = `
        <div class="space-y-2">
            <div class="text-sm text-gray-400 mb-3">
                <?php echo e(__("Tổng số")); ?>: ${data.total_count} <?php echo e(__("tài liệu")); ?>
    ...
    data.transactions.forEach(transaction => {
        ...
        const statusText = transaction.is_overdue ? '<?php echo e(__("Quá hạn")); ?>' : '<?php echo e(__("Đang mượn")); ?>';
            ...
            <div class="flex items-center space-x-3 p-3 bg-gray-800/50 rounded-lg hover:bg-gray-800/70 transition-colors">
                ...
                <div class="flex-1">
                    ...
                    <div class="text-xs mt-1">
                        ...
                        <?php echo e(__("Mượn")); ?>: ${transaction.checkout_time} • 
                        <?php echo e(__("Hạn")); ?>: ${transaction.due_time} • 
                        <?php echo e(__("Thời gian")); ?>: ${transaction.duration}
                    </div>
                </div>
            </div>
        `;
...
function processReadingRoomCheckin() {
    ...
    if (checkboxes.length === 0) {
        Swal.fire({
            icon: 'warning',
            title: '<?php echo e(__("Thông báo")); ?>',
            text: '<?php echo e(__("Vui lòng chọn ít nhất một tài liệu để trả")); ?>',
            confirmButtonColor: '#3b82f6'
        });
        return;
    }
    ...
    Swal.fire({
        title: '<?php echo e(__("Đang xử lý")); ?>',
        text: '<?php echo e(__("Đang trả tài liệu mượn đọc...")); ?>',
        allowOutsideClick: false,
        didOpen: () => {
            Swal.showLoading();
        }
    ...
    // Make API call
    fetch('<?php echo e(route("admin.circulation.reading-room.checkin")); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
    ...
    .then(data => {
        if (data.success) {
            ...
            data.data.checked_in_items.forEach(item => {
                itemsHtml += `<li>${item.book_title} (${item.barcode}) - <?php echo e(__("Thời gian")); ?>: ${item.duration}</li>`;
            });
            ...
            Swal.fire({
                ...
                html: `
                    ...
                    <small style="text-align: left; display: block;">
                        <strong><?php echo e(__("Các tài liệu đã trả")); ?>:</strong><br>
                        <ul>${itemsHtml}</ul>
                    </small>
                `,
                confirmButtonColor: '#3b82f6'
...
function loadAllReadingRoomTransactions() {
    fetch('<?php echo e(route("admin.circulation.reading-room.active")); ?>')
        .then(response => response.json())
        .then(data => {
            if (data.success) {
...
function displayAllReadingRoomTransactions(data) {
    ...
    if (data.transactions.length === 0) {
        container.innerHTML = `
            <div class="text-center text-gray-500 py-4">
                <p class="text-sm"><?php echo e(__("Không có tài liệu nào đang mượn đọc")); ?></p>
            </div>
        `;
        return;
    }
    ...
    let html = `
        <div class="mb-3 text-sm">
            <span class="text-gray-400"><?php echo e(__("Tổng số")); ?>: ${data.total_count}</span>
            ${data.overdue_count > 0 ? `<span class="text-red-400 ml-3"><?php echo e(__("Quá hạn")); ?>: ${data.overdue_count}</span>` : ''}
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                <thead class="bg-gray-800 text-xs uppercase">
                    <tr>
                        <th class="p-2 text-left"><?php echo e(__("Bạn đọc")); ?></th>
                        <th class="p-2 text-left"><?php echo e(__("Tài liệu")); ?></th>
                        <th class="p-2 text-left"><?php echo e(__("Mã vạch")); ?></th>
                        <th class="p-2 text-left"><?php echo e(__("Mượn")); ?></th>
                        <th class="p-2 text-left"><?php echo e(__("Hạn")); ?></th>
                        <th class="p-2 text-left"><?php echo e(__("Thời gian")); ?></th>
                        <th class="p-2 text-left"><?php echo e(__("Trạng thái")); ?></th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-700">
    `;
...
function processPlaceHold() {
    ...
    Swal.fire({
        title: '<?php echo e(__("Đang xử lý")); ?>',
        text: '<?php echo e(__("Đang giữ lại sách...")); ?>',
        allowOutsideClick: false,
        didOpen: () => {
            Swal.showLoading();
        }
    ...
    // Make API call
    fetch('<?php echo e(route("admin.circulation.hold.place")); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
            ...
            Swal.fire({
                ...
                html: `
                    ...
                    <small>
                        <strong><?php echo e(__("Bạn đọc")); ?>:</strong> ${data.data.patron_name}<br>
                        <strong><?php echo e(__("Tài liệu")); ?>:</strong> ${data.data.book_title}<br>
                        <strong><?php echo e(__("Trạng thái")); ?>:</strong> ${data.data.status_display}<br>
                        <strong><?php echo e(__("Hết hạn")); ?>:</strong> ${data.data.expiry_date}
                    </small>
                `,
                confirmButtonColor: '#3b82f6'
            });
...
function loadPatronReservations() {
    ...
    fetch(`<?php echo e(route("admin.circulation.hold.patron")); ?>?patron_code=${patronCode}`)
        .then(response => response.json())
        .then(data => {
            if (data.success) {
...
function displayPatronReservations(data) {
    ...
    if (data.reservations.length === 0) {
        container.innerHTML = `
            <div class="text-center text-gray-500 py-8">
                ...
                <p class="text-sm"><?php echo e(__("Bạn đọc không có reservation nào đang hoạt động")); ?></p>
            </div>
        `;
        return;
    }
    ...
    let html = `
        <div class="space-y-2">
            <div class="text-sm text-gray-400 mb-3">
                <?php echo e(__("Tổng số")); ?>: ${data.total_count} <?php echo e(__("reservation")); ?>
                ...
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <div class="text-xs mt-1 space-y-1">
                            ...
                            <div><?php echo e(__("Đặt giữ")); ?>: ${reservation.reservation_date}</div>
                            <div><?php echo e(__("Hết hạn")); ?>: ${reservation.expiry_date}</div>
                            ${reservation.position ? `<div><?php echo e(__("Vị trí trong hàng chờ")); ?>: #${reservation.position}</div>` : ''}
                            <div><?php echo e(__("Điểm nhận")); ?>: ${reservation.pickup_branch}</div>
                        </div>
                    </div>
                    <div class="flex space-x-2 ml-3">
                        ${reservation.status === 'ready' ? `
                            <button onclick="fulfillReservation(${reservation.id})" 
                                    ...
                                    title="<?php echo e(__("Cho mượn")); ?>">
                                <i class="fas fa-hand-holding"></i>
                            </button>
                        ` : ''}
                        <button onclick="cancelReservation(${reservation.id})" 
                                class="text-red-400 hover:text-red-300 text-xs" 
                                title="<?php echo e(__("Hủy")); ?>">
...
function cancelReservation(reservationId) {
    Swal.fire({
        title: '<?php echo e(__("Xác nhận hủy")); ?>',
        text: '<?php echo e(__("Bạn có chắc muốn hủy reservation này?")); ?>',
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#dc2626',
        cancelButtonColor: '#6b7280',
        confirmButtonText: '<?php echo e(__("Hủy")); ?>',
        cancelButtonText: '<?php echo e(__("Không")); ?>'
    }).then((result) => {
        if (result.isConfirmed) {
            // Show loading
            Swal.fire({
                title: '<?php echo e(__("Đang xử lý")); ?>',
                text: '<?php echo e(__("Đang hủy reservation...")); ?>',
                allowOutsideClick: false,
                didOpen: () => {
                    Swal.showLoading();
                }
            ...
            fetch('<?php echo e(route("admin.circulation.hold.cancel")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
function fulfillReservation(reservationId) {
    Swal.fire({
        title: '<?php echo e(__("Xác nhận cho mượn")); ?>',
        text: '<?php echo e(__("Chuyển reservation thành mượn sách?")); ?>',
        icon: 'question',
        showCancelButton: true,
        confirmButtonColor: '#10b981',
        cancelButtonColor: '#6b7280',
        confirmButtonText: '<?php echo e(__("Cho mượn")); ?>',
        cancelButtonText: '<?php echo e(__("Hủy")); ?>'
    }).then((result) => {
        if (result.isConfirmed) {
            // Show loading
            Swal.fire({
                title: '<?php echo e(__("Đang xử lý")); ?>',
                text: '<?php echo e(__("Đang cho mượn sách...")); ?>',
                allowOutsideClick: false,
                didOpen: () => {
                    Swal.showLoading();
                }
            ...
            fetch('<?php echo e(route("admin.circulation.hold.fulfill")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                ...
                if (data.success) {
                    Swal.fire({
                        ...
                        html: `
                            ${data.message}<br><br>
                            <small>
                                <strong><?php echo e(__("Hạn trả")); ?>:</strong> ${data.data.due_date}<br>
                                <strong><?php echo e(__("Ngày mượn")); ?>:</strong> ${data.data.loan_date}
                            </small>
                        `,
                        confirmButtonColor: '#3b82f6'
                    });
...
function loadAllReservations() {
    fetch('<?php echo e(route("admin.circulation.hold.all")); ?>')
        .then(response => response.json())
        .then(data => {
            if (data.success) {
...
function displayAllReservations(data) {
    ...
    if (data.reservations.length === 0) {
        container.innerHTML = `
            <div class="text-center text-gray-500 py-4">
                <p class="text-sm"><?php echo e(__("Không có reservation nào đang hoạt động")); ?></p>
            </div>
        `;
        return;
    }
    ...
    let html = `
        <div class="mb-3 text-sm">
            <span class="text-gray-400"><?php echo e(__("Tổng số")); ?>: ${data.total_count}</span>
            <span class="text-green-400 ml-3"><?php echo e(__("Sẵn sàng")); ?>: ${data.ready_count}</span>
            <span class="text-yellow-400 ml-3"><?php echo e(__("Đang chờ")); ?>: ${data.pending_count}</span>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                <thead class="bg-gray-800 text-xs uppercase">
                    <tr>
                        ...
                        <th class="p-2 text-left"><?php echo e(__("Tài liệu")); ?></th>
                        <th class="p-2 text-left"><?php echo e(__("Mã vạch")); ?></th>
                        <th class="p-2 text-left"><?php echo e(__("Đặt giữ")); ?></th>
                        <th class="p-2 text-left"><?php echo e(__("Hết hạn")); ?></th>
                        <th class="p-2 text-left"><?php echo e(__("Trạng thái")); ?></th>
                        <th class="p-2 text-left"><?php echo e(__("Vị trí")); ?></th>
                        <th class="p-2 text-left"><?php echo e(__("Hành động")); ?></th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-700">
    `;
...
async function approveLoanRequest(id) {
    if (typeof SwalHelper === 'undefined') {
        const result = await Swal.fire({
            ...
            text: '<?php echo e(__("Bạn có chắc chắn muốn phê duyệt yêu cầu mượn này?")); ?>',
            icon: 'question',
            showCancelButton: true,
            confirmButtonColor: '#10b981',
            cancelButtonColor: '#6b7280',
    ...
    Swal.fire({ title: '<?php echo e(__("Đang xử lý...")); ?>', allowOutsideClick: false, didOpen: () => { Swal.showLoading(); } });
...
function openRejectLoanModal(id) {
    Swal.fire({
        title: '<?php echo e(__("Từ chối yêu cầu")); ?>',
        input: 'textarea',
        inputLabel: '<?php echo e(__("Lý do từ chối")); ?>',
        inputPlaceholder: '<?php echo e(__("Nhập lý do để thông báo cho độc giả...")); ?>',
        inputAttributes: {
            'aria-label': '<?php echo e(__("Lý do từ chối")); ?>'
        },
        showCancelButton: true,
        confirmButtonText: '<?php echo e(__("Xác nhận từ chối")); ?>',
