            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div class="flex items-center gap-3 bg-emerald-50 px-4 py-2 rounded-sm border border-emerald-100">
                    ...
                    <div>
                        ...
                        <p class="text-xs font-bold text-vttu-dark mt-1">Kết nối thành công (<?php echo e(number_format($totalRecords ?? 0)); ?> biểu ghi)</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="bg-white p-3 rounded-md border border-slate-100 hover:border-vttu-red/20 transition-all group flex flex-col shadow-sm hover:shadow-md">
                        ...
                        <a href="<?php echo e(route('opac.book.show', $book->id)); ?>" class="block aspect-[3/4] bg-slate-100 rounded-md mb-3 border border-slate-100 group-hover:bg-vttu-red/5 transition-colors overflow-hidden relative">
                            ...
                            <div class="absolute top-2 right-2">
                                <span class="px-2 py-0.5 bg-white/90 backdrop-blur text-vttu-dark rounded-sm text-[8px] font-bold uppercase tracking-widest shadow-sm"><?php echo e($book->record_type ?? 'Sách'); ?></span>
                            </div>
                        </a>
                    ...
                    <div class="bg-white p-4 rounded-md border border-slate-100 hover:border-vttu-red/20 transition-all group shadow-sm hover:shadow-md">
                        <div class="flex gap-4">
                            ...
                            <div class="w-20 aspect-[3/4] bg-slate-100 rounded-sm overflow-hidden flex-shrink-0 border border-slate-100">
                                <?php if($book->cover_image): ?>
                                    <img src="<?php echo e(asset('storage/' . $book->cover_image)); ?>" class="w-full h-full object-contain mix-blend-multiply">
                                <?php else: ?>
                                    <div class="w-full h-full flex items-center justify-center bg-slate-50">
                            ...
                            <div class="flex-1 flex flex-col">
                                <div class="flex justify-between items-start gap-4">
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <?php if($summary): ?>
                                            <p class="text-[11px] text-slate-500 line-clamp-2 leading-relaxed mb-0 italic">"<?php echo e(Str::limit($summary, 200)); ?>"</p>
                                        <?php endif; ?>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <a href="<?php echo e(route('opac.book.show', $book->id)); ?>" class="inline-flex items-center px-4 py-2 bg-vttu-red hover:bg-vttu-dark text-white text-[9px] font-bold uppercase tracking-widest rounded-sm transition-all shadow-sm">
                                            Chi tiết
            ...
            <div class="lg:col-span-3 space-y-4" data-aos="fade-left">
                ...
                <div class="bg-white rounded-md p-4 shadow-sm border border-slate-100">
                    ...
                    <div class="space-y-2">
                        ...
                        <a href="<?php echo e(route('opac.search', ['location' => $location->id])); ?>" class="flex justify-between items-center group">
                            <span class="text-xs font-medium text-slate-600 group-hover:text-vttu-red transition-colors truncate pr-2"><?php echo e($location->name); ?></span>
                            <span class="bg-slate-50 text-slate-400 px-1.5 py-0.5 rounded-sm text-[9px] font-bold group-hover:bg-vttu-red/10 group-hover:text-vttu-red transition-all"><?php echo e($location->book_items_count); ?></span>
                        </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="bg-vttu-dark rounded-md p-4 shadow-sm text-white">
                    ...
                    <div class="space-y-3 max-h-[300px] overflow-y-auto pr-1.5 custom-scrollbar">
                        ...
                        <a href="<?php echo e(route('opac.search', ['ddc' => $ddc['code']])); ?>" class="flex justify-between items-start group border-b border-white/5 pb-1.5 last:border-0">
                            <div class="flex flex-col">
                                <span class="text-[9px] font-bold text-vttu-yellow tracking-widest"><?php echo e($ddc['code']); ?></span>
                                <span class="text-xs font-medium text-white/70 group-hover:text-white transition-colors leading-tight"><?php echo e($ddc['name']); ?></span>
                            </div>
                            <span class="text-[9px] font-bold bg-white/10 px-1.5 py-0.5 rounded-sm group-hover:bg-vttu-yellow group-hover:text-vttu-dark transition-all"><?php echo e($ddc['count']); ?></span>
                        </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="bg-white rounded-md p-4 shadow-sm border border-slate-100">
                    ...
                    <div class="flex flex-wrap gap-1.5">
                        ...
                        <a href="<?php echo e(route('opac.search', ['q' => $tag])); ?>" class="px-2.5 py-1 bg-slate-50 hover:bg-vttu-red hover:text-white text-slate-500 text-[9px] font-bold uppercase tracking-widest rounded-sm transition-all border border-slate-100">
                            <?php echo e($tag); ?>
