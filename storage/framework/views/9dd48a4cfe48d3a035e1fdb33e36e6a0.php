            ...
            <div class="lg:col-span-3 space-y-8" data-aos="fade-left">
                ...
                <div class="bg-vttu-dark rounded-3xl p-6 shadow-xl shadow-vttu-red/20 text-white">
                    ...
                    <div class="space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                        ...
                        ?>
                        <?php $__currentLoopData = $ddc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="#" class="flex justify-between items-start group border-b border-white/5 pb-2 last:border-0">
                            <div class="flex flex-col">
                                <span class="text-[10px] font-black text-vttu-yellow tracking-widest"><?php echo e($code); ?></span>
                                <span class="text-xs font-bold text-white/70 group-hover:text-white transition-colors"><?php echo e($data['name']); ?></span>
                            </div>
                            <span class="text-[10px] font-black bg-white/10 px-2 py-0.5 rounded group-hover:bg-vttu-yellow group-hover:text-vttu-dark transition-all"><?php echo e($data['count']); ?></span>
                        </a>
                ...
                <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php $__currentLoopData = ['Hồ Chí Minh', 'Mỹ Thuật', 'Giáo dục', 'Môi trường', 'Kỹ năng sống']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
