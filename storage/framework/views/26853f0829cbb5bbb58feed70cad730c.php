                        ...
                        <div id="info-grid" class="grid grid-cols-1 gap-6 transition-all duration-500" :class="sidebarOpen ? 'md:grid-cols-2' : 'md:grid-cols-2'">
                            <div class="bg-white rounded-md shadow-sm border border-slate-100 overflow-hidden" data-aos="fade-up">
                                    <div class="bg-vttu-red px-4 py-3 flex items-center justify-between">
                                        <h3 class="text-sm font-bold text-white uppercase tracking-tight"><?php echo e(__('THÔNG BÁO')); ?></h3>
                                        <a href="#" class="text-vttu-yellow text-[10px] font-bold uppercase tracking-widest hover:underline"><?php echo e(__('Xem tất cả')); ?></a>
                                    </div>
                                    <div class="p-3">
                                        <?php if(isset($homeAnnouncements) && $homeAnnouncements->count() > 0): ?>
                                            <?php $firstAnn = $homeAnnouncements->first(); ?>
                                            <div class="mb-3 aspect-video rounded-md overflow-hidden bg-slate-100 relative group">
                                                <a href="<?php echo e($firstAnn->url); ?>" class="w-full h-full block">
                                                    <img src="<?php echo e($firstAnn->featured_image ?? 'https://img.freepik.com/free-vector/breaking-news-concept_23-2148514216.jpg'); ?>" 
                                            ...
                                            <div class="space-y-2">
                                                <?php $__currentLoopData = $homeAnnouncements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <a href="<?php echo e($item->url); ?>" class="flex items-start gap-2 text-vttu-dark hover:text-vttu-red transition-colors group">
                                                        <span class="text-vttu-red mt-1">•</span>
                                                        <div class="flex-1">
                                                            <p class="text-xs font-medium line-clamp-2 leading-snug group-hover:underline"><?php echo e($item->title); ?></p>
                                                            <p class="text-[10px] text-slate-400 mt-0.5"><?php echo e($item->created_at->format('H:i:s')); ?></p>
                                                        </div>
                                                    </a>
                            ...
                            <div class="bg-white rounded-md shadow-sm border border-slate-100 overflow-hidden" data-aos="fade-up">
                                <div class="bg-vttu-red px-4 py-3 flex items-center justify-between">
                                    <h3 class="text-sm font-bold text-white uppercase tracking-tight"><?php echo e(__('TIN TỨC SỰ KIỆN')); ?></h3>
                                    <a href="<?php echo e(route('news.index')); ?>" class="text-vttu-yellow text-[10px] font-bold uppercase tracking-widest hover:underline"><?php echo e(__('Xem tất cả')); ?></a>
                                </div>
                                <div class="p-3">
                                    <?php if(isset($homeNews) && $homeNews->count() > 0): ?>
                                        ...
                                        ?>
                                        <div class="mb-3 aspect-video rounded-md overflow-hidden bg-slate-100 relative group">
                                            <a href="<?php echo e($firstNews->url); ?>" class="w-full h-full block">
                                                <img src="<?php echo e($firstNews->featured_image ?? 'https://img.freepik.com/free-vector/breaking-news-concept_23-2148514216.jpg'); ?>" 
                                                     class="w-full h-full object-cover hover:scale-105 transition-transform duration-500"
                                                     onerror="this.onerror=null;this.src='https://img.freepik.com/free-vector/breaking-news-concept_23-2148514216.jpg'">
                                            </a>
                                        </div>
                                        <div class="space-y-2">
                                            <?php $__currentLoopData = $homeNews->sortBy('sort_order')->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="<?php echo e($item->url); ?>" class="flex items-start gap-2 text-vttu-dark hover:text-vttu-red transition-colors group">
                                                    <span class="text-vttu-red mt-1">•</span>
                                                    <div class="flex-1">
                                                        <p class="text-xs font-medium line-clamp-2 leading-snug group-hover:underline"><?php echo e($item->title); ?></p>
                        ...
                        <div class="bg-white rounded-md shadow-sm border border-slate-100 p-4" data-aos="fade-up">
                            <div class="flex items-center gap-4 border-b border-slate-100 pb-3 mb-4" id="news-tabs">
                                <button @click="loadNewsTab('news', 'news-tabs', 'news-content')"
                                    class="tab-btn text-sm font-bold px-4 py-1.5 rounded-sm transition-all <?php echo e(($activeNewsType ?? 'news') === 'news' ? 'text-white bg-vttu-red shadow-sm' : 'text-slate-400 hover:text-vttu-red'); ?>">
                                    <?php echo e(__('TIN MỚI')); ?>

                                </button>
                                <button @click="loadNewsTab('video', 'news-tabs', 'news-content')"
                                    class="tab-btn text-sm font-bold px-4 py-1.5 rounded-sm transition-all <?php echo e(($activeNewsType ?? '') === 'video' ? 'text-white bg-vttu-red shadow-sm' : 'text-slate-400 hover:text-vttu-red'); ?>">
                                    <?php echo e(__('VIDEO')); ?>

                                </button>
                            </div>
                            <div id="news-content" class="min-h-[200px] relative">
                                <?php echo $__env->make('site.pages.partials.home-news', ['homeNews' => $tabNews ?? $homeNews], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-md p-4 text-vttu-dark border border-slate-100 shadow-sm relative overflow-hidden" data-aos="fade-up">
                            ...
                            <div class="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-4 items-center mb-10">
                                ...
                                <div class="md:col-span-9 space-y-3">
                                    ...
                                    <h3 class="text-xl font-bold leading-tight text-vttu-dark uppercase"><?php echo e(__('GIỚI THIỆU SÁCH HÀNG THÁNG')); ?></h3>
                                    <p class="text-xs text-slate-500 leading-relaxed"><?php echo e(__('Khám phá những tựa sách hay và giá trị nhất được đội ngũ thủ thư VTTU chọn lọc kỹ lưỡng dành cho bạn.')); ?></p>
                                    <a href="<?php echo e(route('opac.search')); ?>" class="inline-block px-6 py-2 bg-vttu-yellow text-vttu-dark text-xs font-bold rounded-sm hover:bg-yellow-400 transition-all shadow-sm text-center"><?php echo e(__('Khám phá ngay')); ?></a>
                                </div>
                            </div>
                            ...
                            <div class="mt-6 pt-6 border-t border-slate-50">
                                <div class="flex gap-3">
                                    <?php if(isset($bookIntroductionNews) && count($bookIntroductionNews) > 0): ?>
                                        <?php $__currentLoopData = $bookIntroductionNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="bg-white p-2.5 rounded-md border border-slate-100 hover:border-vttu-red/20 transition-all group flex flex-col shadow-sm w-[160px] flex-shrink-0">
                                            ...
                                            <div class="aspect-[3/4] bg-slate-50 rounded-sm mb-2 border border-slate-50 flex items-center justify-center overflow-hidden relative">
                                                <?php if($item->featured_image): ?>
                                                    <img src="<?php echo e($item->featured_image); ?>" class="w-full h-full object-contain">
                                                <?php else: ?>
                                            ...
                                            <div class="flex-grow flex flex-col gap-1.5">
                                                <a href="<?php echo e($item->url); ?>" class="text-[10px] font-bold text-vttu-dark group-hover:text-vttu-red transition-colors leading-tight line-clamp-2 min-h-[1.5rem]">
                                                ...
                                                <p class="text-[9px] font-medium text-slate-500 flex items-center gap-1 truncate">
                                                    ...
                                                    <?php echo e($item->author->name ?? 'VTTU'); ?>
                                                ...
                                                <div class="mt-auto pt-1.5 flex items-center justify-between border-t border-slate-50">
                                                    ...
                                                    <a href="<?php echo e($item->url); ?>" class="w-5 h-5 rounded-sm bg-slate-50 flex items-center justify-center text-vttu-red hover:bg-vttu-red hover:text-white transition-all shadow-sm">
                                        ...
                                        <div class="bg-white p-2.5 rounded-md border border-slate-100 hover:border-vttu-red/20 transition-all group flex flex-col shadow-sm w-[160px] flex-shrink-0">
                                            ...
                                            <div class="flex-grow flex flex-col gap-1.5">
                                                <h3 class="text-[10px] font-bold text-vttu-dark group-hover:text-vttu-red transition-colors leading-tight line-clamp-2 min-h-[1.5rem]">
                                                    <?php echo e($i == 1 ? 'Giáo trình Kinh tế phát triển' : 'Giáo trình Lý thuyết giải phẫu chức năng hệ vận động'); ?>

                                                </h3>

                                                <p class="text-[9px] font-medium text-slate-500 flex items-center gap-1 truncate">
                                                    <i class="fas fa-user-edit text-[7px] text-vttu-red"></i>
                                                    <?php echo e($i == 1 ? 'Phí Thị Hằng' : 'Hoàng Anh Lân'); ?>
                        ...
                        <div class="bg-white rounded-md p-4 shadow-sm border border-slate-100" data-aos="fade-up">
                            <div class="flex items-center gap-3 border-b border-slate-100 pb-3 mb-4 overflow-x-auto" id="medical-tabs">
                                <button @click="loadMedicalTab('Sản khoa', 'medical-tabs', 'medical-content')"
                                    class="tab-btn text-xs font-bold text-white bg-vttu-red px-4 py-1.5 rounded-sm shadow-sm whitespace-nowrap transition-all uppercase"><?php echo e(__('SẢN KHOA')); ?></button>
                                <button @click="loadMedicalTab('Nhi khoa', 'medical-tabs', 'medical-content')"
                                    class="tab-btn text-xs font-bold text-slate-400 hover:text-vttu-red px-4 py-1.5 rounded-sm whitespace-nowrap transition-all uppercase"><?php echo e(__('NHI KHOA')); ?></button>
                                <button @click="loadMedicalTab('Nội khoa', 'medical-tabs', 'medical-content')"
                                    class="tab-btn text-xs font-bold text-slate-400 hover:text-vttu-red px-4 py-1.5 rounded-sm whitespace-nowrap transition-all uppercase"><?php echo e(__('NỘI KHOA')); ?></button>
                            </div>
                    ...
                    <div class="space-y-4 min-w-[280px]">
                        ...
                        <div class="bg-vttu-red p-4 rounded-md relative overflow-hidden group shadow-sm" data-aos="fade-left">
                            <div class="flex items-center gap-3 mb-4 relative z-10">
                                ...
                                <h3 class="text-lg font-bold text-white tracking-tight leading-tight uppercase"><?php echo e(__('THỜI GIAN')); ?><br><?php echo e(__('PHỤC VỤ')); ?></h3>
                            </div>
                            <div class="space-y-2 relative z-10">
                                <div class="flex justify-between items-center p-3 bg-white/10 backdrop-blur-sm rounded-sm border border-white/10 hover:bg-white/20 transition-all">
                                    <span class="font-medium text-white/90 text-[11px] uppercase tracking-widest"><?php echo e(__('Thứ 2 - Thứ 6')); ?></span>
                                    <span class="font-bold text-vttu-yellow text-sm">7:30 - 20:00</span>
                                </div>
                                <div class="flex justify-between items-center p-3 bg-white/10 backdrop-blur-sm rounded-sm border border-white/10 hover:bg-white/20 transition-all">
                                    <span class="font-medium text-white/90 text-[11px] uppercase tracking-widest"><?php echo e(__('Thứ 7 - CN')); ?></span>
                        ...
                        <div class="bg-white p-4 rounded-md shadow-sm border border-slate-100" data-aos="fade-left">
                            <div class="flex bg-slate-50 p-1 rounded-sm mb-4" id="resource-tabs">
                                <button @click="loadResourceTab($event, 'new', 'resource-tabs', 'resources-content')"
                                    class="tab-btn flex-1 py-2 text-[10px] font-bold text-center rounded-sm transition-all <?php echo e(($activeResourceType ?? 'new') === 'new' ? 'text-white bg-vttu-red shadow-sm uppercase tracking-widest' : 'text-slate-400 hover:text-vttu-red uppercase tracking-widest'); ?>">
                                    <?php echo e(__('Mới')); ?>

                                </button>
                                <button @click="loadResourceTab($event, 'featured', 'resource-tabs', 'resources-content')"
                                    class="tab-btn flex-1 py-2 text-[10px] font-bold text-center rounded-sm transition-all <?php echo e(($activeResourceType ?? '') === 'featured' ? 'text-white bg-vttu-red shadow-sm uppercase tracking-widest' : 'text-slate-400 hover:text-vttu-red uppercase tracking-widest'); ?>">
                        ...
                        <div class="grid grid-cols-1 gap-2" data-aos="fade-left">
                            <a href="#" class="flex items-center justify-between p-4 bg-vttu-red rounded-sm text-white shadow-sm hover:-translate-y-0.5 transition-all group">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="font-bold text-[11px] uppercase tracking-widest"><?php echo e(__('Tài nguyên mở')); ?></span>
                                </div>
                            ...
                            <a href="#" class="flex items-center justify-between p-4 bg-vttu-dark rounded-sm text-white shadow-sm hover:-translate-y-0.5 transition-all group">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="font-bold text-[11px] uppercase tracking-widest"><?php echo e(__('Học liệu số')); ?></span>
                                </div>
                                <i class="fas fa-arrow-right text-[10px] group-hover:translate-x-1 transition-transform"></i>
                            </a>
                        </div>
