    ...
    <section id="explore" class="py-32 relative" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="group p-10 bg-white rounded-[3rem] border border-slate-100 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 relative overflow-hidden text-center card-3d" data-aos="zoom-in" data-aos-delay="<?php echo e($loop->index * 50); ?>">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-<?php echo e($f['color']); ?>-500/5 rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform"></div>
                    <div class="relative z-10">
                        <div class="w-20 h-20 bg-<?php echo e($f['color']); ?>-600/10 rounded-3xl flex items-center justify-center text-<?php echo e($f['color']); ?>-600 mx-auto mb-8 group-hover:bg-<?php echo e($f['color']); ?>-600 group-hover:text-white transition-all shadow-lg">
                            <i class="fas <?php echo e($f['icon']); ?> text-3xl"></i>
                        </div>
                        <h3 class="text-2xl font-black text-slate-900 mb-2"><?php echo e($f['name']); ?></h3>
                        <p class="text-sm font-bold text-slate-400 uppercase tracking-widest"><?php echo e($f['count']); ?> Tài liệu</p>
                    </div>
                </div>
    ...
    <section class="py-32 bg-white relative overflow-hidden" data-aos="fade-up" data-aos-delay="200">
        <div class="w-full px-4 md:px-12 lg:px-24">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-8">
                ...
                ?>
                <?php $__currentLoopData = $vttuResources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="group cursor-pointer" data-aos="zoom-in" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                    ...
                    <div class="space-y-1">
                        <span class="text-[9px] font-black text-blue-600 uppercase tracking-widest"><?php echo e($item['type']); ?></span>
                        <h4 class="text-sm font-black text-slate-900 line-clamp-2 group-hover:text-blue-600 transition-colors leading-tight"><?php echo e($item['title']); ?></h4>
                        <p class="text-[10px] text-slate-500 font-bold italic"><?php echo e($item['author']); ?></p>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <section class="py-32" data-aos="fade-up" data-aos-delay="300">
        ...
        <div class="w-full px-4 md:px-12 lg:px-24">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6">
                <?php $__currentLoopData = $newResources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="group cursor-pointer card-3d" data-aos="zoom-in" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                    ...
                    <div class="space-y-1">
                        <h4 class="text-sm font-black text-slate-900 line-clamp-2 group-hover:text-blue-600 transition-colors leading-tight"><?php echo e($resource->title); ?></h4>
                        <p class="text-[10px] text-slate-500 font-bold italic">
                            <?php echo e(is_array($resource->authors) ? implode(', ', $resource->authors) : $resource->authors); ?>
    ...
    <section class="py-32 bg-slate-50 relative overflow-hidden border-y border-slate-100" data-aos="fade-up" data-aos-delay="400">
        ...
        <div class="w-full px-4 md:px-12 lg:px-24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                <?php $__currentLoopData = $medicalResources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white p-8 rounded-[3rem] border border-slate-200/60 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group card-3d" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                    ...
                    <div class="space-y-4">
                        <h4 class="text-xl font-black text-slate-900 leading-tight group-hover:text-red-600 transition-colors"><?php echo e($resource->title); ?></h4>
                        <p class="text-sm text-slate-400 font-bold uppercase tracking-widest italic">
                            <?php echo e(is_array($resource->authors) ? implode(', ', $resource->authors) : $resource->authors); ?>

                        </p>
                        <p class="text-slate-500 text-sm leading-relaxed line-clamp-2"><?php echo e($resource->description); ?></p>
                        
                        <div class="pt-4 flex items-center gap-4 text-xs font-black text-slate-400">
                            <span class="flex items-center gap-1"><i class="far fa-eye"></i> <?php echo e($resource->view_count); ?></span>
                            <span class="flex items-center gap-1"><i class="far fa-arrow-alt-circle-down"></i> <?php echo e($resource->download_count); ?></span>
                        </div>

                        <a href="<?php echo e(route('admin.digital-resources.show', $resource->id)); ?>" class="inline-flex items-center gap-2 text-red-600 font-black text-xs uppercase tracking-widest pt-4 group/btn">
                            Khám phá ngay
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div class="lg:col-span-8">
                    ...
                    <div class="space-y-6">
                        ...
                        ?>
                        <?php $__currentLoopData = $vttuNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group flex flex-col md:flex-row gap-8 p-8 rounded-[2.5rem] bg-slate-50 hover:bg-white border border-transparent hover:border-blue-200 hover:shadow-2xl transition-all duration-500">
                            ...
                            <div class="space-y-3 py-2">
                                <div class="flex items-center gap-4">
                                    <span class="px-3 py-1 bg-blue-600 text-white text-[9px] font-black uppercase tracking-widest rounded-lg shadow-sm"><?php echo e($news['tag']); ?></span>
                                    <span class="text-[10px] font-bold text-slate-400 tracking-widest"><i class="far fa-calendar-alt mr-1 text-blue-500"></i> <?php echo e($news['date']); ?></span>
                                </div>
                                <h4 class="text-2xl font-black text-slate-900 group-hover:text-blue-600 transition-colors line-clamp-2 leading-tight"><?php echo e($news['title']); ?></h4>
                                <p class="text-slate-500 text-sm leading-relaxed line-clamp-2"><?php echo e($news['desc']); ?></p>
        ...
        <div class="px-4 md:px-12 lg:px-24">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="space-y-4">
                    ...
                    <div class="group bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                        <div class="flex justify-between items-center">
                            <h4 class="text-lg font-black text-slate-900 group-hover:text-blue-600 transition-colors"><?php echo e($faq['q']); ?></h4>
