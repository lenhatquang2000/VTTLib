                ...
                <div class="lg:col-span-9 space-y-6">
                    ...
                    <div class="bg-white/95 backdrop-blur-sm rounded-3xl p-6 shadow-xl shadow-black/5 border border-slate-100" data-aos="fade-up">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            ?>
                            <?php $__currentLoopData = $mockBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="group cursor-pointer">
                                <div class="aspect-[3/4] bg-slate-100 rounded-2xl overflow-hidden mb-4 relative shadow-sm group-hover:shadow-xl transition-all">
                                    <img src="<?php echo e($book['img']); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                                    <div class="absolute inset-0 bg-vttu-red/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                </div>
                                <h4 class="font-black text-vttu-dark text-sm line-clamp-2 group-hover:text-vttu-red transition-colors"><?php echo e($book['title']); ?></h4>
                            </div>
                    ...
                    <div class="bg-white/95 backdrop-blur-sm rounded-3xl p-6 shadow-xl shadow-black/5 border border-slate-100" data-aos="fade-up">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            ?>
                            <?php $__currentLoopData = $mockMedical; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-6 bg-slate-50 rounded-3xl border border-slate-100 hover:border-vttu-red/20 hover:bg-vttu-red/5 transition-all group cursor-pointer">
                                <div class="w-12 h-12 bg-vttu-red/10 rounded-2xl flex items-center justify-center text-vttu-red mb-4 group-hover:bg-vttu-red group-hover:text-white transition-all">
                                    <i class="fas <?php echo e($res['icon']); ?>"></i>
                                </div>
                ...
                <div class="lg:col-span-3 space-y-0 divide-y divide-vttu-red/10">
                    ...
                    <div class="bg-white p-6 shadow-xl" data-aos="fade-left">
                        ...
                        <div class="space-y-4">
                            ...
                            ?>
                            <?php $__currentLoopData = $mockRightDocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="#" class="flex gap-4 items-center group">
                                ...
                                <span class="text-xs font-bold text-vttu-dark group-hover:text-vttu-red transition-colors line-clamp-2 leading-tight"><?php echo e($doc); ?></span>
                            </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
