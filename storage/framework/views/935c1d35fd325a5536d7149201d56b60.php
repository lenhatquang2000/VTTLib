<div class="space-y-4 animate-fade-in" 
    ...
    <div class="flex items-center justify-between bg-card p-3 border border-border rounded-sm shadow-sm" x-show="!isFullscreen" x-transition>
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('site.digital-resources.show', $resource->id)); ?>" 
               ...
               title="<?php echo e(__('Quay lại chi tiết')); ?>">
        ...
        <div class="flex items-center gap-2">
            <?php if(auth()->guard()->check()): ?>
                ...
                <a href="<?php echo e(route('admin.digital-resources.download', $resource->id)); ?>"
                   class="hidden md:flex items-center px-4 py-2 bg-[#3b82f6] text-white rounded-sm text-[10px] font-black uppercase tracking-widest hover:bg-blue-600 active:scale-95 transition-all shadow-sm">
                    <i data-lucide="download" class="w-3.5 h-3.5 mr-1.5"></i> <?php echo e(__('Tải tài liệu')); ?>
            ...
            <button @click="isFullscreen = true; if(typeof sidebarOpen !== 'undefined') sidebarOpen = false" 
                ...
                <i data-lucide="maximize" class="w-3.5 h-3.5 mr-1.5"></i> <?php echo e(__('Mở rộng tối đa')); ?>
    ...
    <?php if(!$resource->file_url): ?>
        <div class="w-full h-full flex flex-col items-center justify-center bg-muted/20">
            ...
            <h3 class="text-sm font-bold text-foreground uppercase tracking-widest"><?php echo e(__('Không thể tải file PDF')); ?></h3>
            <p class="text-xs text-muted-foreground mt-2"><?php echo e(__('Vui lòng kiểm tra lại đường dẫn tệp tin hoặc liên hệ quản trị viên.')); ?></p>
            <a href="<?php echo e(route('site.digital-resources.show', $resource->id)); ?>" class="mt-6 text-xs font-bold text-vttu-red hover:underline italic">
                <i data-lucide="arrow-left" class="w-3 h-3 inline mr-1"></i> <?php echo e(__('Quay lại trang chi tiết')); ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
            ...
            if (limit > 0 && totalPages > limit) {
                ...
                promoCard.innerHTML = `
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
                        ...
                        <a href="<?php echo e(route('site.digital-resources.show', $resource->id)); ?>" class="text-[10px] font-bold text-slate-300 hover:text-primary transition-colors">Quay lại chi tiết</a>
                    </div>
                `;
        ...
        <?php if(auth()->guard()->check()): ?>
            ...
            console.log('User Name:', '<?php echo e(auth()->user()->full_name); ?>');
            console.log('Patron Group Info:', {
                id: <?php echo e($patronGroup?->id ?? 'null'); ?>,
                name: '<?php echo e($patronGroup?->name ?? "None"); ?>',
                code: '<?php echo e($patronGroup?->code ?? "None"); ?>'
            });
            console.log('-----------------------');
        <?php else: ?>
...
<?php /**PATH E:\Workspace\VTTU\Laravel\VTTLib\resources\views/site/pages/partials/digital-resource-view-content.blade.php ENDPATH**/ ?>