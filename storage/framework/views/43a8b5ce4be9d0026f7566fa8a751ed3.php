<div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
    ...
    <div class="lg:col-span-4 bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 overflow-hidden sticky top-6">
        <div class="p-5 border-b border-gray-100 dark:border-slate-800 bg-gray-50/50 dark:bg-slate-800/50">
            <h3 class="text-sm font-bold text-gray-800 dark:text-slate-100 uppercase tracking-wider flex items-center">
                ...
                <span x-text="editingIndex !== null ? '<?php echo e(__('Modify Item')); ?>' : '<?php echo e(__('THÊM BẢN SÁCH MỚI')); ?>'"></span>
            </h3>
        </div>
        <div class="p-6 space-y-4">
            <div class="grid grid-cols-1 gap-4">
                <div class="space-y-1">
                    <label class="block text-[10px] font-bold text-gray-500 dark:text-slate-400 uppercase tracking-widest"><?php echo e(__('MÃ VẠCH')); ?></label>
                ...
                <div class="space-y-1">
                    <label class="block text-[10px] font-bold text-gray-500 dark:text-slate-400 uppercase tracking-widest"><?php echo e(__('SỐ ĐĂNG KÝ CÁ BIỆT')); ?></label>
            ...
            <div class="grid grid-cols-2 gap-3">
                <div class="space-y-1">
                    <label class="block text-[10px] font-bold text-gray-500 dark:text-slate-400 uppercase tracking-widest"><?php echo e(__('CHI NHÁNH')); ?></label>
                ...
                <div class="space-y-1">
                    <label class="block text-[10px] font-bold text-gray-500 dark:text-slate-400 uppercase tracking-widest"><?php echo e(__('KHO LƯU TRỮ')); ?></label>
            ...
            <div class="grid grid-cols-2 gap-3">
                <div class="space-y-1">
                    <label class="block text-[10px] font-bold text-gray-500 dark:text-slate-400 uppercase tracking-widest"><?php echo e(__('THỂ LOẠI LƯU TRỮ')); ?></label>
                    <select x-model="newItem.storage_type"
                        class="w-full px-4 py-2.5 bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 appearance-none">
                        <option value="Book"><?php echo e(__('Sách')); ?></option>
                        <option value="Daily newspaper"><?php echo e(__('Báo hàng ngày')); ?></option>
                        <option value="Magazine"><?php echo e(__('Tạp chí')); ?></option>
                    </select>
                </div>
                <div class="space-y-1">
                    <label class="block text-[10px] font-bold text-gray-500 dark:text-slate-400 uppercase tracking-widest"><?php echo e(__('TRẠNG THÁI')); ?></label>
                    <select x-model="newItem.status"
                        ...
                        <option value="available"><?php echo e(__('Sẵn có')); ?></option>
                        <option value="borrowed"><?php echo e(__('Đang mượn')); ?></option>
                        <option value="lost"><?php echo e(__('Đã mất')); ?></option>
            ...
            <div class="space-y-1">
                <label class="block text-[10px] font-bold text-gray-500 dark:text-slate-400 uppercase tracking-widest"><?php echo e(__('GHI CHÚ')); ?></label>
                <textarea x-model="newItem.notes" rows="2" class="w-full px-4 py-2.5 bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg text-sm" placeholder="<?php echo e(__('Ghi chú...')); ?>"></textarea>
            </div>
            ...
            <div class="space-y-1" x-show="editingIndex === null">
                ...
                <input type="number" x-model="batchQuantity" min="1"
                    class="w-full px-4 py-2.5 bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg text-sm font-mono focus:ring-2 focus:ring-indigo-500 transition-all">
                <p class="text-[9px] text-gray-400 mt-1 italic">Auto-generate items based on this quantity</p>
            </div>
            ...
            <div class="flex gap-2 pt-2">
                <button type="button" @click="addItem()" class="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-4 rounded-xl transition-all shadow-sm flex items-center justify-center space-x-2">
                    ...
                    <span class="uppercase tracking-widest" x-text="editingIndex !== null ? '<?php echo e(__('Cập nhật')); ?>' : '+ <?php echo e(__('Thêm mục')); ?>'"></span>
                </button>
    ...
    <div class="lg:col-span-8 bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 overflow-hidden">
        <div class="p-5 border-b border-gray-100 dark:border-slate-800 bg-gray-50/50 dark:bg-slate-800/50 flex justify-between items-center">
            <h3 class="text-sm font-bold text-gray-800 dark:text-slate-100 uppercase tracking-wider"><?php echo e(__('CÁC MỤC TRONG HÀNG ĐỢI')); ?></h3>
            <span class="bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 text-[10px] font-bold px-2.5 py-1 rounded-full" x-text="items.length + ' <?php echo e(__('Mục')); ?>'"></span>
        </div>
        <div class="overflow-x-auto min-h-[400px]">
            <table class="w-full text-left">
                <thead class="bg-gray-50 dark:bg-slate-800/50 text-[10px] font-bold text-gray-400 dark:text-slate-500 uppercase tracking-widest border-b border-gray-100 dark:border-slate-800">
                    <tr>
                        <th class="px-6 py-4"><?php echo e(__('THÔNG TIN NHẬN DIỆN')); ?></th>
                        <th class="px-6 py-4"><?php echo e(__('LƯU TRỮ')); ?></th>
                        <th class="px-6 py-4"><?php echo e(__('TRẠNG THÁI')); ?></th>
                        <th class="px-6 py-4"><?php echo e(__('BARCODE IMAGE')); ?></th>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    <span class="text-sm font-bold text-gray-700 dark:text-slate-300" x-text="item.storage_type"></span>
...
<?php /**PATH E:\Workspace\VTTU\Laravel\VTTLib\resources\views/admin/marc_books/components/items_tab.blade.php ENDPATH**/ ?>