...
<div class="circulation-page">
    ...
    <div class="page-header">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                <h1 class="page-title"><?php echo e(__('Circulation_Policies')); ?></h1>
                <p class="page-subtitle"><?php echo e(__('Manage_patron_groups_and_loan_policies')); ?></p>
            </div>
            <div class="flex gap-2">
                <button onclick="openModal('addPatronGroupModal')" class="btn-primary">
                    <?php echo e(__('Add_Patron_Group')); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <?php $__empty_1 = true; $__currentLoopData = $patronGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="card-admin rounded-lg overflow-hidden">
            <!-- Group Header -->
            <div class="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                <div>
                    <h3 class="font-bold text-lg"><?php echo e($group->name); ?></h3>
                    <span class="text-xs text-gray-500 dark:text-gray-400 font-mono"><?php echo e($group->code); ?></span>
                </div>
                <div class="flex gap-2">
                    <button onclick="editPatronGroup(<?php echo e(json_encode($group)); ?>)" class="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 text-sm">
                        <?php echo e(__('Edit')); ?>

                    </button>
                    <form action="<?php echo e(route('admin.circulation.patron-groups.destroy', $group)); ?>" method="POST" class="inline"
                        onsubmit="return confirm('<?php echo e(__('Delete_this_patron_group?')); ?>')">
                        <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                        <button type="submit" class="text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 text-sm"><?php echo e(__('Delete')); ?></button>
                    </form>
                </div>
            </div>
            ...
            <div class="p-4">
                <?php if($group->description): ?>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-4"><?php echo e($group->description); ?></p>
                <?php endif; ?>

                <div class="flex justify-between items-center mb-3">
                    <h4 class="text-sm font-bold text-gray-700 dark:text-gray-300"><?php echo e(__('Policies')); ?></h4>
                    <button onclick="openAddPolicyModal(<?php echo e($group->id); ?>, '<?php echo e($group->name); ?>')" 
                        class="text-xs text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                        + <?php echo e(__('Add_Policy')); ?>

                    </button>
                </div>

                <?php $__empty_2 = true; $__currentLoopData = $group->circulationPolicies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $policy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                <div class="policy-card <?php echo e($policy->is_active ? 'active' : ''); ?>">
                    <div class="flex justify-between items-start">
                        <div>
                            <span class="font-medium text-lg"><?php echo e($policy->name); ?></span>
                            <?php if($policy->is_active): ?>
                                <span class="ml-2 text-xs bg-green-100 dark:bg-green-900/50 text-green-800 dark:text-green-400 px-2 py-0.5 rounded"><?php echo e(__('Active')); ?></span>
                            <?php endif; ?>
                        </div>
                        <div class="flex gap-2">
                            <button onclick="editPolicy(<?php echo e(json_encode($policy)); ?>)" class="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 text-sm transition-colors">
                                <?php echo e(__('Edit')); ?>

                            </button>
                            <form action="<?php echo e(route('admin.circulation.policies.destroy', $policy)); ?>" method="POST" class="inline"
                                onsubmit="return confirm('<?php echo e(__('Delete_this_policy?')); ?>')">
                                <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                <button type="submit" class="text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 text-sm transition-colors"><?php echo e(__('Delete')); ?></button>
                            </form>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4 text-sm">
                        <div>
                            <span class="block text-gray-600 dark:text-gray-500"><?php echo e(__('Loan_Days')); ?></span>
                            <span class="font-mono font-semibold"><?php echo e($policy->max_loan_days); ?></span>
                        </div>
                        <div>
                            <span class="block text-gray-600 dark:text-gray-500"><?php echo e(__('Max_Items')); ?></span>
                            <span class="font-mono font-semibold"><?php echo e($policy->max_items); ?></span>
                        </div>
                        <div>
                            <span class="block text-gray-600 dark:text-gray-500"><?php echo e(__('Fine/Day')); ?></span>
                            <span class="font-mono font-semibold"><?php echo e(number_format($policy->fine_per_day)); ?>đ</span>
                        </div>
                        <div>
                            <span class="block text-gray-600 dark:text-gray-500"><?php echo e(__('Renewals')); ?></span>
                            <span class="font-mono font-semibold"><?php echo e($policy->max_renewals); ?></span>
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                <div class="text-center py-8 text-gray-500 dark:text-gray-400">
                    <p class="text-lg"><?php echo e(__('No_policies_defined')); ?></p>
                    <button onclick="openAddPolicyModal(<?php echo e($group->id); ?>, '<?php echo e($group->name); ?>')" 
        ...
        <div class="col-span-2 text-center py-12 text-gray-500 dark:text-gray-400">
            <p><?php echo e(__('No_patron_groups_found')); ?></p>
            <button onclick="openModal('addPatronGroupModal')" class="mt-4 btn-primary">
                <?php echo e(__('Create_First_Group')); ?>
...
<div id="addPatronGroupModal" class="modal hidden">
    ...
    <div class="modal-content">
        <h3 class="text-lg font-bold mb-4"><?php echo e(__('Add_Patron_Group')); ?></h3>
        <form action="<?php echo e(route('admin.circulation.patron-groups.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="space-y-4">
                <div>
                    <label class="block text-sm font-medium mb-1"><?php echo e(__('Group_Name')); ?> *</label>
                    <input type="text" name="name" required class="input-field w-full" placeholder="<?php echo e(__('e.g._Students')); ?>">
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1"><?php echo e(__('Code')); ?> *</label>
                    <input type="text" name="code" required class="input-field w-full" placeholder="<?php echo e(__('e.g._SV')); ?>">
                </div>
                <div>
                ...
                <div>
                    <label class="block text-sm font-medium mb-1"><?php echo e(__('Order')); ?></label>
                    <input type="number" name="order" value="0" class="input-field w-full">
                </div>
            </div>
            <div class="flex justify-end gap-2 mt-6">
                <button type="button" onclick="closeModal('addPatronGroupModal')" class="btn-secondary"><?php echo e(__('Cancel')); ?></button>
                <button type="submit" class="btn-primary"><?php echo e(__('Create')); ?></button>
            </div>
        </form>
    </div>
</div>
...
<div id="editPatronGroupModal" class="modal hidden">
    ...
    <div class="modal-content">
        <h3 class="text-lg font-bold mb-4"><?php echo e(__('Edit_Patron_Group')); ?></h3>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-2 pt-6">
                        ...
                        <label for="editGroupActive" class="text-sm"><?php echo e(__('Active')); ?></label>
                    </div>
                </div>
            </div>
            <div class="flex justify-end gap-2 mt-6">
                <button type="button" onclick="closeModal('editPatronGroupModal')" class="btn-secondary"><?php echo e(__('Cancel')); ?></button>
...
<div id="addPolicyModal" class="modal hidden">
    ...
    <div class="modal-content max-w-2xl">
        <h3 class="text-lg font-bold mb-4"><?php echo e(__('Add_Circulation_Policy')); ?></h3>
        <p class="text-sm text-gray-600 dark:text-gray-400 mb-4"><?php echo e(__('For_group')); ?>: <span id="policyGroupName" class="font-bold"></span></p>
        <form action="<?php echo e(route('admin.circulation.policies.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="patron_group_id" id="policyGroupId">
            
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium mb-1"><?php echo e(__('Policy_Name')); ?> *</label>
                    <input type="text" name="name" required class="input-field w-full" placeholder="<?php echo e(__('e.g._Standard_Loan')); ?>">
                </div>
                
                <!-- Loan Settings -->
                <div class="md:col-span-2 border-t border-gray-200 dark:border-gray-700 pt-4 mt-2">
                    <h4 class="text-sm font-bold text-gray-700 dark:text-gray-300 mb-3"><?php echo e(__('Loan_Settings')); ?></h4>
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1"><?php echo e(__('Max_Loan_Days')); ?> *</label>
                    <input type="number" name="max_loan_days" value="14" required min="1" max="365" class="input-field w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1"><?php echo e(__('Max_Items')); ?> *</label>
                    <input type="number" name="max_items" value="5" required min="1" max="100" class="input-field w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1"><?php echo e(__('Max_Renewals')); ?> *</label>
                    <input type="number" name="max_renewals" value="2" required min="0" max="10" class="input-field w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1"><?php echo e(__('Renewal_Days')); ?> *</label>
                    <input type="number" name="renewal_days" value="7" required min="1" max="365" class="input-field w-full">
                </div>

                <!-- Fine Settings -->
                <div class="md:col-span-2 border-t border-gray-200 dark:border-gray-700 pt-4 mt-2">
                    <h4 class="text-sm font-bold text-gray-700 dark:text-gray-300 mb-3"><?php echo e(__('Fine_Settings')); ?></h4>
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1"><?php echo e(__('Fine_Per_Day')); ?> (VND) *</label>
                    <input type="number" name="fine_per_day" value="1000" required min="0" class="input-field w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1"><?php echo e(__('Max_Fine')); ?> (VND) *</label>
                    <input type="number" name="max_fine" value="100000" required min="0" class="input-field w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1"><?php echo e(__('Grace_Period_Days')); ?> *</label>
                    <input type="number" name="grace_period_days" value="0" required min="0" max="30" class="input-field w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1"><?php echo e(__('Max_Outstanding_Fine')); ?> (VND) *</label>
                    <input type="number" name="max_outstanding_fine" value="50000" required min="0" class="input-field w-full">
                </div>

                <!-- Reservation Settings -->
                <div class="md:col-span-2 border-t border-gray-200 dark:border-gray-700 pt-4 mt-2">
                    <h4 class="text-sm font-bold text-gray-700 dark:text-gray-300 mb-3"><?php echo e(__('Reservation_Settings')); ?></h4>
                </div>
                <div class="flex items-center gap-2">
                    <input type="checkbox" name="can_reserve" id="canReserve" value="1" checked class="rounded">
                    <label for="canReserve" class="text-sm"><?php echo e(__('Can_Reserve')); ?></label>
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1"><?php echo e(__('Max_Reservations')); ?> *</label>
                    <input type="number" name="max_reservations" value="3" required min="0" max="20" class="input-field w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1"><?php echo e(__('Reservation_Hold_Days')); ?> *</label>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <label for="policyActive" class="text-sm"><?php echo e(__('Set_as_Active_Policy')); ?></label>
                </div>
            ...
            <div class="flex justify-end gap-2 mt-6">
                <button type="button" onclick="closeModal('addPolicyModal')" class="btn-secondary"><?php echo e(__('Cancel')); ?></button>
                <button type="submit" class="btn-primary"><?php echo e(__('Create_Policy')); ?></button>
            </div>
        </form>
    </div>
</div>
...
<div id="editPolicyModal" class="modal hidden">
    ...
    <div class="modal-content max-w-2xl">
        <h3 class="text-lg font-bold mb-4"><?php echo e(__('Edit_Circulation_Policy')); ?></h3>
        <form id="editPolicyForm" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <label for="editCanReserve" class="text-sm"><?php echo e(__('Can_Reserve')); ?></label>
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1"><?php echo e(__('Max_Reservations')); ?> *</label>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <label for="editPolicyActive" class="text-sm"><?php echo e(__('Set_as_Active_Policy')); ?></label>
                </div>
            ...
            <div class="flex justify-end gap-2 mt-6">
                <button type="button" onclick="closeModal('editPolicyModal')" class="btn-secondary"><?php echo e(__('Cancel')); ?></button>
                <button type="submit" class="btn-primary"><?php echo e(__('Update_Policy')); ?></button>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    function editPatronGroup(group) {
        document.getElementById('editPatronGroupForm').action = `<?php echo e(route('admin.circulation.patron-groups.update', ['patronGroup' => ':id'])); ?>`.replace(':id', group.id);
    ...
    function editPolicy(policy) {
        document.getElementById('editPolicyForm').action = `<?php echo e(route('admin.circulation.policies.update', ['policy' => ':id'])); ?>`.replace(':id', policy.id);
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Workspace\VTTU\Laravel\VTTLib\resources\views/admin/circulation/index.blade.php ENDPATH**/ ?>