    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden relative transform transition-all">
            <div class="p-8">
                ...
                <form action="<?php echo e(route('admin.marc.framework.store')); ?>" method="POST" class="space-y-5">
                    <?php echo csrf_field(); ?>
                    <div>
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden relative transform transition-all">
            <div class="p-8">
                ...
                <form :action="`<?php echo e(route('admin.marc.framework.update', ['framework' => ':id'])); ?>`.replace(':id', framework.id)" method="POST" class="space-y-5">
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden relative transform transition-all">
            <div class="p-8">
                ...
                <form action="<?php echo e(route('admin.marc.tag.store')); ?>" method="POST" class="space-y-5">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="tag" value="<?php echo e(old('tag')); ?>" placeholder="e.g. 245" maxlength="3" required class="w-full <?php $__errorArgs = ['tag'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 ring-2 ring-rose-500/20 <?php else: ?> border-gray-200 dark:border-slate-700 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> bg-gray-50 dark:bg-slate-800 rounded-xl p-4 text-sm focus:ring-2 focus:ring-indigo-500 dark:text-slate-100 transition font-mono font-bold shadow-sm">
                        <?php $__errorArgs = ['tag'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="mt-1.5 text-[10px] font-bold text-rose-500 uppercase tracking-widest"><?php echo e($message); ?></p>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden relative transform transition-all">
            <div class="p-8">
                ...
                <form :action="`<?php echo e(route('admin.marc.tag.update', ['tag' => ':id'])); ?>`.replace(':id', tag.id)" method="POST" class="space-y-5">
                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                    <input type="hidden" name="framework_id" value="<?php echo e($frameworkId); ?>">
                    <div>
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden relative transform transition-all">
            <div class="p-8">
                ...
                <form action="<?php echo e(route('admin.marc.subfield.store')); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="code" value="<?php echo e(old('code')); ?>" placeholder="e.g. a" maxlength="1" required class="w-full <?php $__errorArgs = ['code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 ring-2 ring-rose-500/20 <?php else: ?> border-gray-200 dark:border-slate-700 <?php unset($message);
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden relative transform transition-all">
            <div class="p-8">
                ...
                <form :action="`<?php echo e(route('admin.marc.subfield.update', ['subfield' => ':id'])); ?>`.replace(':id', subfield.id)" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                    <div>
...
<?php /**PATH E:\Workspace\VTTU\Laravel\VTTLib\resources\views/admin/marc_definitions/modals.blade.php ENDPATH**/ ?>