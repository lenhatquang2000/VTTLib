    ...
    <section class="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div class="w-full px-4 md:px-12 lg:px-24 relative z-10 pt-16 pb-24">
            ...
            <nav class="flex items-center gap-3 text-xs font-bold uppercase tracking-widest text-slate-500 mb-10" data-aos="fade-down" data-aos-delay="100">
                ...
                <i class="fas fa-chevron-right text-[7px]"></i>
                <span class="<?php echo e($badgeColor); ?>"><?php echo e($node->display_name); ?></span>
            </nav>

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div data-aos="fade-right" data-aos-delay="200">
                    <div class="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-white/[0.06] border border-white/10 backdrop-blur-xl text-[10px] font-black uppercase tracking-[0.35em] <?php echo e($badgeColor); ?> mb-8">
                        <span class="relative flex h-2 w-2">
                            <span class="animate-ping absolute inline-flex h-full w-full rounded-full <?php echo e($pingColor); ?> opacity-75"></span>
                            <span class="relative inline-flex rounded-full h-2 w-2 <?php echo e($pingColor); ?>"></span>
                        </span>
                                ...
                                <?php $__currentLoopData = $sidebarItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <a href="<?php echo e($item->getUrl()); ?>"
                                       class="group flex items-center gap-4 px-5 py-4 rounded-2xl transition-all duration-300 mb-1
                                              <?php echo e($active ? $activeNav : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'); ?>">
                ...
                <div class="lg:col-span-9 order-1 lg:order-2 space-y-8" data-aos="fade-up" data-aos-delay="200">
                    <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 overflow-hidden">
                        ...
                        <div class="px-10 pt-10 pb-0">
                            <div class="flex items-center gap-4 mb-8">
                                <div class="w-12 h-12 rounded-2xl bg-gradient-to-br <?php echo e($accentGradient); ?> flex items-center justify-center shadow-lg <?php echo e($accentShadow); ?>">
                                    <i class="<?php echo e($badgeIcon); ?> text-white text-lg"></i>
                                </div>
                                <div>
                                    <div class="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]"><?php echo e($sectionLabel); ?></div>
                                    <h2 class="text-2xl md:text-3xl font-black text-slate-900 tracking-tight"><?php echo e($node->display_name); ?></h2>
                                </div>
                            </div>
                            <div class="h-px bg-gradient-to-r <?php echo e($accentDivider); ?> via-slate-200 to-transparent"></div>
                        </div>
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-5">
                        ...
                        <div class="w-full md:w-1/2">
                            <?php if($prev): ?>
                                <a href="<?php echo e($prev->getUrl()); ?>" class="group flex items-center gap-5 p-6 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:border-blue-200 transition-all duration-300">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm font-bold text-slate-800 group-hover:text-blue-600 transition-colors"><?php echo e($prev->display_name); ?></div>
                                    </div>
                                </a>
                            <?php endif; ?>
                        </div>
                        <div class="w-full md:w-1/2">
                            <?php if($next): ?>
                                <a href="<?php echo e($next->getUrl()); ?>" class="group flex items-center justify-end gap-5 p-6 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:border-blue-200 transition-all duration-300 text-right">
                                    <div>
                                        <div class="text-[9px] font-black text-slate-400 uppercase tracking-widest">Tiếp theo</div>
                                        <div class="text-sm font-bold text-slate-800 group-hover:text-blue-600 transition-colors"><?php echo e($next->display_name); ?></div>
                                    </div>
                                    <div class="w-11 h-11 bg-slate-100 rounded-xl flex items-center justify-center text-slate-400 group-hover:bg-blue-600 group-hover:text-white transition-all flex-shrink-0">
