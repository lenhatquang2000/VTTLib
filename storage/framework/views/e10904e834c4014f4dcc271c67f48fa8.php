...
<div class="space-y-8 animate-in fade-in duration-700">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
            <h1 class="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-tight"><?php echo e(__('Activity Logs')); ?></h1>
            <p class="text-lg font-medium text-slate-500 dark:text-slate-400 mt-1"><?php echo e(__('Monitor system actions and user operations.')); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-[3rem] shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div class="p-8 border-b border-slate-100 dark:border-slate-700/50">
            <form action="<?php echo e(route('admin.activity-logs.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div class="relative group">
                    <input type="text" name="action" value="<?php echo e(request('action')); ?>" placeholder="<?php echo e(__('Action (e.g. create)')); ?>" 
                ...
                <div class="flex gap-2">
                    ...
                    <?php if(request()->anyFilled(['user_id', 'action', 'method', 'date_from', 'date_to'])): ?>
                        <a href="<?php echo e(route('admin.activity-logs.index')); ?>" class="px-4 py-4 bg-rose-50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400 rounded-[1.25rem] border border-rose-100 dark:border-rose-900/30">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-slate-100 dark:divide-slate-700/50">
                <thead class="bg-slate-50/50 dark:bg-slate-900/50">
                    <tr>
                        <th scope="col" class="px-10 py-6 text-left text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em]"><?php echo e(__('User')); ?></th>
                        <th scope="col" class="px-6 py-6 text-left text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em]"><?php echo e(__('Action')); ?></th>
                        <th scope="col" class="px-6 py-6 text-left text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em]"><?php echo e(__('Method / Status')); ?></th>
                        <th scope="col" class="px-6 py-6 text-left text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em]"><?php echo e(__('URL')); ?></th>
                        <th scope="col" class="px-6 py-6 text-left text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em]"><?php echo e(__('Time')); ?></th>
                        <th scope="col" class="px-10 py-6 text-right text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em]"><?php echo e(__('Details')); ?></th>
                    </tr>
                </thead>
                    ...
                    <tr class="group hover:bg-slate-50/50 dark:hover:bg-slate-900/30 transition-all duration-200">
                        <td class="px-10 py-7 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="text-sm font-black text-slate-900 dark:text-white"><?php echo e($log->user?->name ?? 'Guest'); ?></div>
                                    <div class="text-[10px] text-slate-500 dark:text-slate-400 font-bold"><?php echo e($log->ip_address); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-7">
                        ...
                        <td class="px-6 py-7">
                            <div class="flex items-center space-x-2">
                                <span class="px-2 py-1 text-[9px] font-black uppercase rounded <?php echo e($log->method == 'DELETE' ? 'bg-rose-50 text-rose-600 dark:bg-rose-900/30 dark:text-rose-400' : 
                                ...
                                <?php if($log->status_code): ?>
                                    <span class="text-[10px] font-bold <?php echo e($log->status_code >= 400 ? 'text-rose-500' : 'text-emerald-500'); ?>">
                        ...
                        <td class="px-6 py-7">
                            <div class="text-[10px] text-slate-500 dark:text-slate-400 font-mono truncate max-w-[200px]" title="<?php echo e($log->url); ?>">
                                <?php echo e($log->url); ?>
                        ...
                        <td class="px-10 py-7 text-right">
                            <button onclick="openLogModal(<?php echo e($log->id); ?>)" class="p-3 bg-slate-50 dark:bg-slate-900 text-slate-400 dark:text-slate-500 hover:text-indigo-600 dark:hover:text-indigo-400 rounded-xl transition-all border border-transparent hover:border-indigo-100 dark:hover:border-indigo-900/30">
                    ...
                    <tr>
                        <td colspan="6" class="px-10 py-20 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-slate-400 dark:text-slate-500 text-sm font-bold"><?php echo e(__('No activities found in the signal stream.')); ?></p>
                            </div>
                        </td>
                    </tr>
                    <?php endif; ?>
        ...
        <div class="inline-block w-full max-w-4xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl">
            <div class="p-10">
                <div class="flex items-center justify-between mb-8">
                    <h3 class="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tight"><?php echo e(__('Activity Payload Analysis')); ?></h3>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Workspace\VTTU\Laravel\VTTLib\resources\views/admin/activity_logs/index.blade.php ENDPATH**/ ?>