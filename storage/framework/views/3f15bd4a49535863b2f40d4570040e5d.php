...
<div class="space-y-8 animate-in fade-in duration-700">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
            <h1 class="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-tight"><?php echo e(__('Privilege Controller')); ?></h1>
            <p class="text-lg font-medium text-slate-500 dark:text-slate-400 mt-1"><?php echo e(__('Assign and manage security clearances for system subjects.')); ?></p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-[2rem] p-8 text-white shadow-2xl shadow-indigo-500/20 overflow-hidden relative group">
            <div class="relative z-10">
                <p class="text-indigo-100 text-[10px] font-black uppercase tracking-[0.2em]"><?php echo e(__('Total Identities')); ?></p>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-[2rem] p-8 shadow-sm border border-slate-200 dark:border-slate-700 relative overflow-hidden group">
            <p class="text-slate-400 dark:text-slate-500 text-[10px] font-black uppercase tracking-[0.2em]"><?php echo e(__('Active Sessions')); ?></p>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-[2rem] p-8 shadow-sm border border-slate-200 dark:border-slate-700 relative overflow-hidden group">
            <p class="text-slate-400 dark:text-slate-500 text-[10px] font-black uppercase tracking-[0.2em]"><?php echo e(__('New Requests')); ?></p>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-[2.5rem] shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div class="p-8 border-b border-slate-100 dark:border-slate-700/50">
            <form action="<?php echo e(route('admin.users.privileges')); ?>" method="GET" class="flex flex-col lg:flex-row gap-4">
                <div class="relative flex-1 group">
                    ...
                    <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="<?php echo e(__('Search by identity, email or username...')); ?>" 
                ...
                <div class="flex flex-wrap items-center gap-3">
                    <select name="role_id" onchange="this.form.submit()" 
                        ...
                        <option value=""><?php echo e(__('All Clearances')); ?></option>
                    ...
                    <div class="flex gap-2 min-w-full sm:min-w-0">
                        ...
                        <?php if($search || $roleId): ?>
                            <a href="<?php echo e(route('admin.users.privileges')); ?>" class="px-5 py-4 bg-rose-50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400 rounded-[1.25rem] hover:bg-rose-600 hover:text-white transition flex items-center justify-center border border-rose-100 dark:border-rose-900/30">
            ...
            <table class="w-full text-sm text-left">
                <thead>
                    <tr class="bg-slate-50/80 dark:bg-slate-900/50 text-slate-400 dark:text-slate-500 border-b border-slate-100 dark:border-slate-700/50 uppercase text-[10px] font-black tracking-[0.2em]">
                        <th class="px-8 py-6"><?php echo e(__('Identity')); ?></th>
                        <th class="px-6 py-6"><?php echo e(__('Username')); ?></th>
                        <th class="px-6 py-6"><?php echo e(__('Clearance Level')); ?></th>
                        <th class="px-6 py-6"><?php echo e(__('Status / Permissions')); ?></th>
                        <th class="px-8 py-6 text-right"><?php echo e(__('Operations')); ?></th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-slate-50 dark:divide-slate-700/50">
                        ...
                        <tr class="group hover:bg-slate-50/50 dark:hover:bg-slate-900/30 transition-all duration-200">
                            <td class="px-8 py-6 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-black text-slate-900 dark:text-white leading-tight"><?php echo e($ru->user->name); ?></div>
                                        <div class="text-xs font-bold text-slate-400 mt-0.5"><?php echo e($ru->user->email); ?></div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-6">
                                ...
                                ?>
                                <span class="inline-flex items-center px-4 py-1.5 border rounded-xl text-[10px] font-black uppercase tracking-[0.15em] <?php echo e($roleClass); ?>">
                            ...
                            <td class="px-6 py-6">
                                <div class="flex items-center gap-3">
                                    <button
                                        ...
                                        <?php echo e(__('Modify Tabs')); ?> <span class="ml-2 px-2 py-0.5 bg-white dark:bg-slate-800 rounded-lg text-[9px] group-hover/btn:bg-white/20 transition-colors"><?php echo e($ru->sidebars->count()); ?></span>
                                    </button>
                                </div>
                            </td>
                            <td class="px-8 py-6 text-right">
                                <div class="flex justify-end gap-2">
                                    <a href="<?php echo e(route('admin.users.edit', $ru->user_id)); ?>" class="p-2 text-slate-400 hover:text-indigo-600 transition-colors">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="5" class="px-8 py-24 text-center text-slate-500 italic"><?php echo e(__('No privileged identities found.')); ?></td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-[3rem] shadow-2xl relative overflow-hidden max-h-[90vh] flex flex-col border border-slate-200 dark:border-slate-700 animate-modal">
            <div class="p-10 border-b border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-800">
                <div class="flex justify-between items-start">
                    <div>
                        <h3 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight"><?php echo e(__('Access Control Terminal')); ?></h3>
                        ...
                        <?php $__currentLoopData = $sidebars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sidebar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-span-1 md:col-span-2 space-y-4 mb-6 last:mb-0">
                                <label class="flex items-center p-5 bg-white dark:bg-slate-800 rounded-[2rem] border-2 border-slate-100 dark:border-slate-700 shadow-sm cursor-pointer hover:border-indigo-500 transition-all">
                                    <input type="checkbox" name="sidebar_ids[]" value="<?php echo e($sidebar->id); ?>" class="sidebar-checkbox w-6 h-6 rounded-lg text-indigo-600">
                                    <div class="ml-4 font-black uppercase text-sm tracking-wider"><?php echo e(__($sidebar->name)); ?></div>
                                </label>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 pl-8 border-l-2 border-slate-100 dark:border-slate-700">
                                        <?php $__currentLoopData = $sidebar->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="flex items-center p-4 bg-white dark:bg-slate-800 rounded-xl border border-transparent shadow-sm hover:border-indigo-300 transition-all cursor-pointer">
                                                <input type="checkbox" name="sidebar_ids[]" value="<?php echo e($child->id); ?>" class="sidebar-checkbox w-4 h-4 rounded text-indigo-600">
                                                <div class="ml-4 text-xs font-bold uppercase"><?php echo e(__($child->name)); ?></div>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                <?php endif; ?>
