                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 overflow-hidden transition-colors">
                    <div x-data="{ 
                        ...
                        <div class="px-6 py-4 border-b border-slate-50 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/50 flex flex-wrap gap-4 transition-colors">
                            ...
                            <button @click="updateSubTab('holidays')" :class="subTab === 'holidays' ? 'text-indigo-600 dark:text-indigo-400 border-b-2 border-indigo-600 dark:border-indigo-400' : 'text-slate-400 border-b-2 border-transparent hover:text-slate-600'" class="pb-2 text-xs font-bold uppercase tracking-wider transition-all"><?php echo e(__('Holidays')); ?></button>
                            <button @click="updateSubTab('services')" :class="subTab === 'services' ? 'text-indigo-600 dark:text-indigo-400 border-b-2 border-indigo-600 dark:border-indigo-400' : 'text-slate-400 border-b-2 border-transparent hover:text-slate-600'" class="pb-2 text-xs font-bold uppercase tracking-wider transition-all"><?php echo e(__('Services')); ?></button>
                            <button @click="updateSubTab('books')" :class="subTab === 'books' ? 'text-indigo-600 dark:text-indigo-400 border-b-2 border-indigo-600 dark:border-indigo-400' : 'text-slate-400 border-b-2 border-transparent hover:text-slate-600'" class="pb-2 text-xs font-bold uppercase tracking-wider transition-all"><?php echo e(__('Books')); ?></button>
                        </div>
                        ...
                        <div class="p-8">
                            ...
                            <div x-show="subTab === 'books'">
                                <form action="<?php echo e(route('admin.settings.policy.update_digital')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <div class="space-y-4">
                                        ...
                                        <div class="bg-card text-foreground rounded-md border border-border shadow-sm overflow-hidden">
                                            <div class="p-3 border-b border-border flex items-center gap-3 bg-muted/30">
                                                ...
                                                <div>
                                                    <h3 class="text-xs font-bold uppercase tracking-wider"><?php echo e(__('Quyền tải tài liệu số')); ?></h3>
                                                    <p class="text-[10px] text-muted-foreground font-medium"><?php echo e(__('Cấu hình nhóm đối tượng được phép tải tệp tin PDF.')); ?></p>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="flex flex-col p-3 bg-muted/20 rounded border border-border hover:bg-muted/40 hover:border-primary/30 transition-all group">
                                                        <div class="relative flex items-start mb-3">
                                                            <div class="flex items-center h-5">
                                                                <input type="checkbox" name="digital_download_allowed_groups[]" value="<?php echo e($group->id); ?>" 
                                                                       id="group-<?php echo e($group->id); ?>"
                                                                       <?php echo e(in_array($group->id, $allowedGroups) ? 'checked' : ''); ?>

                                                                       class="w-3.5 h-3.5 text-primary border-border rounded focus:ring-primary/20 bg-background transition-all cursor-pointer">
                                                            </div>
                                                            <label for="group-<?php echo e($group->id); ?>" class="ml-2.5 cursor-pointer">
                                                                <span class="block text-xs font-bold text-foreground"><?php echo e($group->name); ?></span>
                                                                <span class="block text-[9px] text-muted-foreground font-mono uppercase tracking-tighter"><?php echo e($group->code); ?></span>
                                                            </label>
                                                            <?php if(in_array($group->id, $allowedGroups)): ?>
                                                        ...
                                                        <div class="mt-auto pt-2 border-t border-border/50 space-y-1">
                                                            <label class="text-[9px] text-muted-foreground uppercase font-black tracking-widest"><?php echo e(__('Số trang xem thử')); ?></label>
                                                            <div class="relative">
                                                                <input type="number" name="digital_view_page_limits[<?php echo e($group->id); ?>]" 
                                                                       value="<?php echo e($viewLimits[$group->id] ?? 0); ?>"
                                                                       min="0"
                                                            ...
                                                            <p class="text-[8px] text-muted-foreground italic"><?php echo e(__('0 = Không giới hạn')); ?></p>
                                                        </div>
                                                    </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>

                                                <?php if($patronGroups->isEmpty()): ?>
                                                <div class="text-center py-6 text-muted-foreground italic text-xs border border-dashed border-border rounded">
                                                    <?php echo e(__('Chưa có nhóm đối tượng nào được định nghĩa.')); ?>
                                        ...
                                        <div class="bg-card text-foreground rounded-md border border-border shadow-sm overflow-hidden">
                                            <div class="p-3 border-b border-border flex items-center gap-3 bg-muted/30">
                                                ...
                                                <div>
                                                    <h3 class="text-xs font-bold uppercase tracking-wider"><?php echo e(__('Cấu hình cho Khách')); ?></h3>
                                                    <p class="text-[10px] text-muted-foreground font-medium"><?php echo e(__('Quyền hạn dành cho người dùng chưa phân nhóm.')); ?></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <div class="flex items-center gap-3 p-3 bg-muted/10 rounded border border-border border-dashed">
                                                    ...
                                                    <div>
                                                        <span class="block text-xs font-bold"><?php echo e(__('Tải tài liệu')); ?></span>
                                                        <span class="block text-[9px] text-muted-foreground uppercase tracking-widest"><?php echo e(__('Locked by Default')); ?></span>
                                                    </div>
                                                </div>
                                                <div class="p-3 bg-muted/10 rounded border border-border border-dashed space-y-1.5">
                                                    ...
                                                    <div class="relative">
                                                        <input type="number" name="digital_view_page_limits[guest]" 
                                                               value="<?php echo e($viewLimits['guest'] ?? 10); ?>"
                                                               min="0"
                                                               class="w-full h-8 bg-background border border-border rounded py-1 px-2.5 text-xs font-bold text-primary focus:ring-1 focus:ring-primary/20 focus:border-primary outline-none transition-all">
                                                        <div class="absolute inset-y-0 right-2.5 flex items-center pointer-events-none text-muted-foreground/30">
                                                            <i data-lucide="file-text" class="w-3 h-3"></i>
                                        ...
                                        <div class="p-3 bg-accent/30 rounded-md border border-border flex items-start gap-3">
                                            ...
                                            <p class="text-[10px] text-muted-foreground leading-relaxed font-medium">
                                                <?php echo e(__('Lưu ý: Chỉ những nhóm được chọn mới thấy nút "Tải". Các nhóm khác (bao gồm Khách) chỉ được xem trực tuyến giới hạn theo số trang cấu hình.')); ?>
                                        ...
                                        <div class="flex items-center justify-end pt-2">
                                            <button type="submit" class="inline-flex items-center gap-2 bg-primary text-primary-foreground px-4 py-2 rounded-sm text-xs font-bold uppercase tracking-widest hover:bg-primary/90 active:scale-95 transition-all shadow-sm">
                                                ...
                                                <?php echo e(__('Lưu chính sách Sách')); ?>
