    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="login-header">
                ...
                <h1 class="login-title"><?php echo e(__('Welcome Back')); ?></h1>
            </div>
            
            <!-- Login Form -->
            <form action="<?php echo e(route('client.login.store')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH E:\Workspace\VTTU\Laravel\VTTLib\resources\views/auth/login.blade.php ENDPATH**/ ?>