                ...
                <div class="space-y-4">
                    ...
                    <div class="border-b border-gray-700 pb-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium mb-1"><?php echo e(__('Display Name (EN)')); ?></label>
                                <input type="text" name="display_name_en" 
                                       class="input-field w-full" 
                                       placeholder="<?php echo e(__('English name shown on menu')); ?>"
                                       value="<?php echo e(old('display_name_en', $siteNode->display_name_en)); ?>">
                            </div>
